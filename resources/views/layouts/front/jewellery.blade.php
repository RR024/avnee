  ...
  <nav class="lg:hidden bg-[#2B003A] border-y border-[#f8c8dc]/40">
    <div class="px-3">
      <ul class="flex items-center justify-start gap-2 py-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
        <li><a href="{{ route('front.products.collection', ['collection' => 'jewellery-new-arrivals']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="{{ route('front.jewellery') }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">JEWELLERY</a></li>
        <li><a href="{{ route('front.products.index', ['category' => 'bags']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">BAGS</a></li>
        <li><a href="{{ route('front.products.index', ['category' => 'footwear']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">FOOTWEAR</a></li>
        ...
        <li><a href="{{ route('front.sale.jewellery') }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">SALE</a></li>
      </ul>
    </div>
  </nav>
  ...
  <nav id="main-nav" class="bg-[#4B0082] hidden lg:block" style="border-top: 1px solid rgba(164, 125, 171, 0.35); border-bottom: 2px solid #A47DAB;">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
      <ul class="flex items-center justify-center gap-4 xl:gap-6 h-12">
        <li><a href="{{ route('front.sale.jewellery') }}" class="nav-item-link rounded-sm">SALE</a></li>
        <li><a href="{{ route('front.products.collection', ['collection' => 'jewellery-new-arrivals']) }}" class="nav-item-link rounded-sm">NEW ARRIVALS</a></li>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12 pt-16">
        ...
        <div class="pr-0 lg:pr-6">
          <h4 class="footer-heading text-[#f3d9ff] font-semibold tracking-[0.12em] uppercase text-[15px]">{{ $footerAboutHeading }}</h4>
        ...
        <!-- Column 2: Shop -->
        <div>
          <h4 class="footer-heading text-[#f3d9ff] font-semibold tracking-[0.12em] uppercase text-[15px]">{{ $footerShopHeading }}</h4>
          <ul class="space-y-3.5">
            <li><a href="{{ route('front.sale.studio.kids') }}" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Kids Collection</a></li>
            <li><a href="{{ route('front.sale.jewellery') }}" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Jewellery</a></li>
            <li><a href="{{ route('front.sale.studio.sarees') }}" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Sarees</a></li>
