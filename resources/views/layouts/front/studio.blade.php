  ...
  <nav class="lg:hidden bg-mulberry border-y border-pastel-pink/40">
    <div class="px-3">
      <ul class="flex items-center gap-2 py-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
        <li><a href="{{ route('front.products.index', ['collection' => 'sale', 'discount' => 1]) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">SALE</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'new-arrivals']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'best-sellers']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">BEST SELLERS</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'bogo']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">BOGO</a></li>
        <li><a href="{{ route('front.products.index', ['category' => 'kids']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">KIDS</a></li>
        ...
        <li><a href="{{ route('front.jewellery') }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">JEWELLERY</a></li>
        ...
        <li><a href="{{ route('front.products.index', ['category' => 'trinkets']) }}" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">FUN TRINKETS</a></li>
      </ul>
    </div>
  </nav>
  ...
  <nav id="main-nav" class="bg-mulberry hidden lg:block" style="border-top: 1px solid rgba(248, 200, 220, 0.35); border-bottom: 2px solid #C75B6E;">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
      <ul class="flex items-center justify-center gap-4 xl:gap-6 h-12">
        <li><a href="{{ route('front.products.index', ['collection' => 'sale', 'discount' => 1]) }}" class="nav-item-link rounded-sm">SALE</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'new-arrivals']) }}" class="nav-item-link rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'best-sellers']) }}" class="nav-item-link rounded-sm">BEST SELLERS</a></li>
        <li><a href="{{ route('front.products.index', ['collection' => 'bogo']) }}" class="nav-item-link rounded-sm">BOGO</a></li>
        <li><a href="{{ route('front.products.index', ['category' => 'kids']) }}" class="nav-item-link rounded-sm">KIDS</a></li>
        <li><a href="{{ route('front.products.index', ['category' => 'sarees']) }}" class="nav-item-link rounded-sm">SAREES</a></li>
        <li class="group relative">
          <a href="{{ route('front.jewellery') }}" class="nav-item-link rounded-sm">JEWELLERY</a>
          <div class="absolute top-full left-1/2 -translate-x-1/2 mega-menu-panel shadow-2xl hidden group-hover:block z-[120] border border-[#F8C8DC]/30">
            <div class="p-4">
              <div class="grid grid-cols-5 gap-3">
                <a href="{{ route('front.products.index', ['category' => 'earrings']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-MAN-C54/AVN-JW-HAN-MAN-C54-01.png') }}" alt="Ear Rings">
                  <span>EAR RINGS</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'bracelets']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-STR-C53/AVN-JW-HAN-STR-C53-01.png') }}" alt="Bracelets">
                  <span>BRACELETS</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'chokers-necklaces']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Viraasat Floral Necklace Set/AVN-JW-NEC-RRD-C57/AVN-JW-NEC-RRD-C57-02.png') }}" alt="Chokers & Necklaces">
                  <span>CHOKERS & NECKLACES</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'rings']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-PIN-C47/AVN-JW-HAN-PIN-C47-01.png') }}" alt="Rings">
                  <span>RINGS</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'toe-rings']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-FLA-C45/AVN-JW-HAN-FLA-C45-01.png') }}" alt="Toe Rings">
                  <span>TOE RINGS</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'bangles']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-SHL-C52/AVN-JW-HAN-SHL-C52-01.png') }}" alt="Bangles">
                  <span>BANGLES</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'maang-tikka']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-BUT-C51/AVN-JW-HAN-BUT-C51-01.png') }}" alt="Maang Tikka">
                  <span>MAANG TIKKA</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'nosepins']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-MAN-C54/AVN-JW-HAN-MAN-C54-01.png') }}" alt="Nosepins">
                  <span>NOSEPINS</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'hair-accessories']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-STR-C53/AVN-JW-HAN-STR-C53-01.png') }}" alt="Hair Accessories">
                  <span>HAIR ACCESSORIES</span>
                </a>
                <a href="{{ route('front.products.index', ['category' => 'chains']) }}" class="mega-card">
                  <img src="{{ asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-PIN-C47/AVN-JW-HAN-PIN-C47-01.png') }}" alt="Chains">
                  <span>CHAIN</span>
                </a>
              </div>
            </div>
        ...
        <li><a href="{{ route('front.products.index', ['category' => 'trinkets']) }}" class="nav-item-link rounded-sm">FUN TRINKETS</a></li>
      </ul>
    </div>
  </nav>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-8 pt-10">
        ...
        <div class="pr-0 lg:pr-6">
          <h4 class="footer-heading text-pastel-pink font-semibold tracking-[0.12em] uppercase text-[17px]">{{ $footerAboutHeading }}</h4>
          <p class="text-pastel-pink/70 text-[18px] leading-[1.8] mb-4">
            {{ $footerAboutParagraph1 }}
          </p>
          <p class="text-pastel-pink/70 text-[16px] leading-[1.8] mb-6">
            {{ $footerAboutParagraph2 }}
          </p>
        ...
        <!-- Column 2: Shop -->
        <div>
          <h4 class="footer-heading text-pastel-pink font-semibold tracking-[0.12em] uppercase text-[15px]">{{ $footerShopHeading }}</h4>
          <ul class="space-y-3.5">
            <li><a href="{{ route('front.sale.studio.kids') }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Kids Collection</a></li>
            <li><a href="{{ route('front.sale.jewellery') }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Jewellery</a></li>
            <li><a href="{{ route('front.sale.studio.sarees') }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Sarees</a></li>
            <li><a href="{{ route('front.sale.jewellery.accessories') }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Hair Accessories</a></li>
            <li><a href="{{ route('front.products.collection', ['collection' => 'organizers']) }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Organizers</a></li>
            <li><a href="{{ route('front.products.collection', ['collection' => 'gifting']) }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Gifting</a></li>
            <li><a href="{{ route('front.products.collection', ['collection' => 'watches']) }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Watches</a></li>
            <li><a href="{{ route('front.sale.studio.trinkets') }}" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Trinkets</a></li>
          </ul>
        </div>
