            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('admin.settings.update') }}" method="POST">
                        ...
                        <!-- Footer Content -->
                        <h3 class="text-lg font-medium mb-4 text-indigo-600 dark:text-indigo-400 border-b pb-2">Footer Content</h3>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            <div>
                                <label for="footer_about_heading" class="block text-sm font-medium text-gray-700 dark:text-gray-300">About Section Title</label>
                                <input type="text" name="footer_about_heading" id="footer_about_heading" value="{{ $settings['footer_about_heading'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_heading" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Section Title</label>
                                <input type="text" name="footer_shop_heading" id="footer_shop_heading" value="{{ $settings['footer_shop_heading'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div class="md:col-span-2">
                                <label for="footer_about_paragraph_1" class="block text-sm font-medium text-gray-700 dark:text-gray-300">About Paragraph 1</label>
                                <textarea name="footer_about_paragraph_1" id="footer_about_paragraph_1" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">{{ $settings['footer_about_paragraph_1'] ?? '' }}</textarea>
                            </div>
                            <div class="md:col-span-2">
                                <label for="footer_about_paragraph_2" class="block text-sm font-medium text-gray-700 dark:text-gray-300">About Paragraph 2</label>
                                <textarea name="footer_about_paragraph_2" id="footer_about_paragraph_2" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">{{ $settings['footer_about_paragraph_2'] ?? '' }}</textarea>
                            </div>
                            <div>
                                <label for="footer_shop_kids_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: Kids Collection</label>
                                <input type="text" name="footer_shop_kids_label" id="footer_shop_kids_label" value="{{ $settings['footer_shop_kids_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_jewellery_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: Jewellery</label>
                                <input type="text" name="footer_shop_jewellery_label" id="footer_shop_jewellery_label" value="{{ $settings['footer_shop_jewellery_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_sarees_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: Sarees</label>
                                <input type="text" name="footer_shop_sarees_label" id="footer_shop_sarees_label" value="{{ $settings['footer_shop_sarees_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_trinkets_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: Funky Trinkets</label>
                                <input type="text" name="footer_shop_trinkets_label" id="footer_shop_trinkets_label" value="{{ $settings['footer_shop_trinkets_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_hair_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: Hair Accessories</label>
                                <input type="text" name="footer_shop_hair_label" id="footer_shop_hair_label" value="{{ $settings['footer_shop_hair_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                            <div>
                                <label for="footer_shop_all_label" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Shop Link: All Collections</label>
                                <input type="text" name="footer_shop_all_label" id="footer_shop_all_label" value="{{ $settings['footer_shop_all_label'] ?? '' }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white sm:text-sm">
                            </div>
                        </div>
