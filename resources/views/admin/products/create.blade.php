                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input id="show_returnable_badge" name="show_returnable_badge" type="checkbox" value="1" checked class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-indigo-600 focus:ring-indigo-500">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input id="show_free_shipping_badge" name="show_free_shipping_badge" type="checkbox" value="1" checked class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-indigo-600 focus:ring-indigo-500">
