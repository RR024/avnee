                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center">
                                    <input type="hidden" name="show_returnable_badge" value="0">
                                    <input id="show_returnable_badge" name="show_returnable_badge" type="checkbox" value="1" {{ ($product->show_returnable_badge ?? true) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-indigo-600 focus:ring-indigo-500">
                                    <label for="show_returnable_badge" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Show "Returnable" Badge on Product Page</label>
                                </div>

                                <div class="flex items-center">
                                    <input type="hidden" name="show_free_shipping_badge" value="0">
                                    <input id="show_free_shipping_badge" name="show_free_shipping_badge" type="checkbox" value="1" {{ ($product->show_free_shipping_badge ?? true) ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 dark:bg-gray-700 text-indigo-600 focus:ring-indigo-500">
                                    <label for="show_free_shipping_badge" class="ml-2 block text-sm text-gray-900 dark:text-gray-300">Show "Free Shipping" Badge on Product Page</label>
                                </div>
