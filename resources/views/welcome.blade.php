    ...
    <div class="max-w-[1440px] mx-auto">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="{{ route('front.products.collection', ['collection' => 'summer-classics']) }}" class="block w-full h-full">
            <img src="{{ asset('images/hero-slider/summer-classics.png') }}" alt="Summer Classics" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="{{ route('front.products.collection', ['collection' => 'birthday-glam']) }}" class="block w-full h-full">
            <img src="{{ asset('images/hero-slider/birthday.png') }}" alt="Birthday Glam" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="{{ route('front.products.collection', ['collection' => 'ugadi-sale']) }}" class="block w-full h-full">
  ...
  <section id="just-in" class="relative w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10 bg-[#FCEFF5] border-y border-[#d5d5d5]">
    <div class="max-w-[1320px] mx-auto">
      ...
      <div class="grid grid-cols-2 gap-4 sm:gap-6">
        ...
        <a href="{{ route('front.products.collection', ['collection' => 'new-arrivals']) }}" class="block w-full border border-[#2B003A]/25 bg-white shadow-sm overflow-hidden">
          <img src="{{ asset('images/just-in/Picture2.png') }}" alt="Just in new launches 2" class="w-full aspect-[16/10] object-cover" />
        </a>
      </div>
    </div>
  </section>
          ...
          <div class="swiper-wrapper">
            @foreach($bestBuyCards as $card)
              ...
              <div class="swiper-slide p-1">
                <article onclick="navigateToBestBuys('{{ $cardSlug }}')" class="bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-sm h-[560px] cursor-pointer transition-transform duration-200 hover:-translate-y-1 flex flex-col">
                  ...
                  <div class="p-3 sm:p-4 flex-1 flex flex-col">
                    ...
                    <p class="mt-auto pt-1 text-lg sm:text-xl font-black leading-none text-[#C75B6E]">₹{{ number_format($card['price'], 0) }}</p>
                  </div>
                </article>
              </div>
            @endforeach
      ...
      <div class="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-x-5 sm:gap-x-7 lg:gap-x-10 xl:gap-x-12 gap-y-5 sm:gap-y-6">
        @foreach($styleCards as $styleCard)
          ...
          <a href="{{ route('front.products.index', ['category' => $styleCard['slug']]) }}" class="group block text-center">
            ...
            <p class="mt-3 text-sm sm:text-base text-[#C75B6E] font-semibold tracking-[0.08em] uppercase">{{ $styleCard['label'] }}</p>
          </a>
        @endforeach
      </div>
    </div>
