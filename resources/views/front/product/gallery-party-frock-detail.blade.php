    ...
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-10 pt-10 pb-24">
        ...
        <div class="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
            <div class="w-full lg:w-[46%] space-y-5">
                <div class="max-w-[480px] mx-auto lg:mx-0 border {{ $borderColor }} bg-white overflow-hidden">
                    <img src="{{ asset('images/coupons/avnee7.jpeg') }}" alt="AVNEE7 Coupon Banner" class="w-full h-auto object-cover" />
                </div>

                <div class="relative aspect-[4/5] max-w-[480px] mx-auto lg:mx-0 overflow-hidden shadow-2xl shadow-black/5 lg:rounded-sm border {{ $borderColor }} bg-white/20">
                ...
                <div id="party-thumbs" class="flex gap-2 overflow-x-auto pb-1 max-w-[480px] mx-auto lg:mx-0 hide-scrollbar">
