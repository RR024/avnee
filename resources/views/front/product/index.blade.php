            ...
            <section class="mb-10 border {{ $borderColor }} {{ $isDark ? 'bg-[#2f003f]' : 'bg-[#fff5f8]' }} overflow-hidden rounded-lg">
                ...
                <div class="p-4 sm:p-6 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
                    @foreach(range(0, 2) as $idx)
                        ...
                        @endphp
                        <a href="{{ $cardRoute }}" class="block group border {{ $borderColor }} {{ $isDark ? 'bg-[#2b003a]' : 'bg-white/85' }} overflow-hidden rounded-lg">
                    ...
                    <div class="w-full lg:w-[320px] flex-shrink-0 lg:px-0 lg:pb-4">
                        <form action="{{ route('front.products.index') }}" method="GET" id="filter-form" class="space-y-5 p-5 {{ $isDark ? 'bg-[#350047] border border-[#4f006a]' : 'bg-gray-50 border border-gray-200' }} rounded-lg">
                            ...
                            <div class="space-y-6">
                                <!-- Gender Filter -->
                                <details class="group">
                                    <summary class="flex justify-between items-center cursor-pointer text-xs font-bold uppercase tracking-wider {{ $mutedColor }} mb-3">
                                        <span>Gender</span>
                                        <span class="inline-block transition-transform group-open:rotate-180">&#9662;</span>
                                    </summary>
                                    <div class="space-y-2">
                                        <label class="flex items-center justify-between cursor-pointer">
                                            <input type="radio" name="gender" value="female" onchange="this.form.submit()" {{ request('gender') == 'female' ? 'checked' : '' }} class="sr-only" />
                                            <span class="flex items-center justify-between w-full px-3 py-2 rounded-lg border {{ request('gender') == 'female' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">
                                                <span>Female</span>
                                                <span class="text-xs opacity-70">1945</span>
                                            </span>
                                        </label>
                                        <label class="flex items-center justify-between cursor-pointer">
                                            <input type="radio" name="gender" value="male" onchange="this.form.submit()" {{ request('gender') == 'male' ? 'checked' : '' }} class="sr-only" />
                                            <span class="flex items-center justify-between w-full px-3 py-2 rounded-lg border {{ request('gender') == 'male' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">
                                                <span>Male</span>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="price_range" value="" onchange="this.form.submit()" {{ !request('price_range') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('price_range') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Prices</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="price_range" value="0-500" onchange="this.form.submit()" {{ request('price_range') == '0-500' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('price_range') == '0-500' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Under 500</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="price_range" value="500-1000" onchange="this.form.submit()" {{ request('price_range') == '500-1000' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('price_range') == '500-1000' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">500 - 1000</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="price_range" value="1000-2000" onchange="this.form.submit()" {{ request('price_range') == '1000-2000' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('price_range') == '1000-2000' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">1000 - 2000</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="price_range" value="2000+" onchange="this.form.submit()" {{ request('price_range') == '2000+' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('price_range') == '2000+' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">2000+</span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="discount" value="" onchange="this.form.submit()" {{ !request('discount') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('discount') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Discounts</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="discount" value="10" onchange="this.form.submit()" {{ request('discount') == '10' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('discount') == '10' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">10% and above</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="discount" value="20" onchange="this.form.submit()" {{ request('discount') == '20' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('discount') == '20' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">20% and above</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="discount" value="30" onchange="this.form.submit()" {{ request('discount') == '30' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('discount') == '30' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">30% and above</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="discount" value="50" onchange="this.form.submit()" {{ request('discount') == '50' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('discount') == '50' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">50% and above</span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="max-h-[320px] overflow-y-auto space-y-1.5 pr-1">
                                        ...
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="category" value="{{ $category['slug'] }}" onchange="this.form.submit()" {{ request('category') == $category['slug'] ? 'checked' : '' }} class="sr-only" />
                                            <span class="flex items-center justify-between px-3 py-2 rounded-lg border {{ request('category') == $category['slug'] ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">
                                                <span>{{ $category['name'] }}</span>
                                                <span class="text-xs opacity-70">{{ $styleCategoryCounts[$category['slug']] ?? ($categoryCountMap[$category['slug']] ?? 0) }}</span>
                                            </span>
                                        </label>
                                        @endforeach
                                    </div>
                                ...
                                <details class="group">
                                    ...
                                    <div class="max-h-[200px] overflow-y-auto space-y-1.5 pr-1">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="sub_category" value="" onchange="this.form.submit()" {{ !request('sub_category') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-md border {{ !request('sub_category') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Sub Categories</span>
                                        </label>
                                ...
                                <details class="group">
                                    ...
                                    <div class="grid grid-cols-4 gap-2">
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="" onchange="this.form.submit()" {{ !request('color') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ !request('color') ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-gradient-to-r from-red-500 via-blue-500 to-green-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="red" onchange="this.form.submit()" {{ request('color') == 'red' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'red' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-red-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="blue" onchange="this.form.submit()" {{ request('color') == 'blue' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'blue' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-blue-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="green" onchange="this.form.submit()" {{ request('color') == 'green' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'green' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-green-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="pink" onchange="this.form.submit()" {{ request('color') == 'pink' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'pink' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-pink-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="yellow" onchange="this.form.submit()" {{ request('color') == 'yellow' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'yellow' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-yellow-500"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="black" onchange="this.form.submit()" {{ request('color') == 'black' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'black' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-black"></span>
                                        </label>
                                        <label class="cursor-pointer">
                                            <input type="radio" name="color" value="white" onchange="this.form.submit()" {{ request('color') == 'white' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block w-full h-8 rounded border-2 {{ request('color') == 'white' ? ($isDark ? 'border-[#d4af37]' : 'border-[#b87333]') : $borderColor }} bg-white"></span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="fabric" value="" onchange="this.form.submit()" {{ !request('fabric') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('fabric') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Fabrics</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="fabric" value="cotton" onchange="this.form.submit()" {{ request('fabric') == 'cotton' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('fabric') == 'cotton' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Cotton</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="fabric" value="silk" onchange="this.form.submit()" {{ request('fabric') == 'silk' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('fabric') == 'silk' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Silk</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="fabric" value="georgette" onchange="this.form.submit()" {{ request('fabric') == 'georgette' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('fabric') == 'georgette' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Georgette</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="fabric" value="chiffon" onchange="this.form.submit()" {{ request('fabric') == 'chiffon' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('fabric') == 'chiffon' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Chiffon</span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="work" value="" onchange="this.form.submit()" {{ !request('work') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('work') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Work</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="work" value="embroidery" onchange="this.form.submit()" {{ request('work') == 'embroidery' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('work') == 'embroidery' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Embroidery</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="work" value="handwork" onchange="this.form.submit()" {{ request('work') == 'handwork' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('work') == 'handwork' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Hand Work</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="work" value="machine" onchange="this.form.submit()" {{ request('work') == 'machine' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('work') == 'machine' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Machine Work</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="work" value="printed" onchange="this.form.submit()" {{ request('work') == 'printed' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('work') == 'printed' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Printed</span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="pattern" value="" onchange="this.form.submit()" {{ !request('pattern') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('pattern') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Patterns</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="pattern" value="floral" onchange="this.form.submit()" {{ request('pattern') == 'floral' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('pattern') == 'floral' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Floral</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="pattern" value="geometric" onchange="this.form.submit()" {{ request('pattern') == 'geometric' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('pattern') == 'geometric' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Geometric</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="pattern" value="abstract" onchange="this.form.submit()" {{ request('pattern') == 'abstract' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('pattern') == 'abstract' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Abstract</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="pattern" value="solid" onchange="this.form.submit()" {{ request('pattern') == 'solid' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('pattern') == 'solid' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Solid</span>
                                        </label>
                                    </div>
                                </details>
                                ...
                                <details class="group">
                                    ...
                                    <div class="space-y-2">
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="store" value="" onchange="this.form.submit()" {{ !request('store') ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ !request('store') ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">All Stores</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="store" value="online" onchange="this.form.submit()" {{ request('store') == 'online' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('store') == 'online' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Online Exclusive</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="store" value="flagship" onchange="this.form.submit()" {{ request('store') == 'flagship' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('store') == 'flagship' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Flagship Store</span>
                                        </label>
                                        <label class="block cursor-pointer">
                                            <input type="radio" name="store" value="outlet" onchange="this.form.submit()" {{ request('store') == 'outlet' ? 'checked' : '' }} class="sr-only" />
                                            <span class="block px-3 py-2 rounded-lg border {{ request('store') == 'outlet' ? ($isDark ? 'border-[#d4af37] text-[#f3d9ff] bg-[#1f0028]' : 'border-[#b87333] text-[#b87333] bg-white') : $borderColor }} text-sm font-medium">Outlet Store</span>
                                        </label>
                                    </div>
                                </details>

                                <button type="submit" class="w-full py-2.5 bg-black text-white text-xs font-bold uppercase tracking-[0.2em] hover:{{ $accentBg }} transition-all rounded-lg">Apply Filters</button>
