...
class CategorySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $jewelleryGallery = Category::where('slug', 'jewellery-gallery')->first();
        if ($jewelleryGallery) {
            $subcategories = [
                [
                    'brand_id' => 2,
                    'parent_id' => $jewelleryGallery->id,
                    'name' => 'Handmade Earrings',
                    'slug' => 'handmade-earrings',
                    'description' => 'Handcrafted earrings with artisanal details.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 1,
                ],
                [
                    ...
                    'name' => 'Resin Earrings',
                    'slug' => 'resin-earrings',
                    'description' => 'Resin styles with playful color and shine.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 2,
                ],
                [
                    ...
                    'description' => 'Handcrafted necklaces for everyday statements.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 3,
                ],
                [
                    ...
                    'description' => 'Oxidized finishes with a vintage feel.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 4,
                ],
                [
                    ...
                    'description' => 'Beaded textures for playful styling.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 5,
                ],
                [
                    ...
                    'name' => 'Studs',
                    'slug' => 'studs',
                    'description' => 'Everyday studs with refined sparkle.',
                    'is_active' => true,
                    'show_in_menu' => true,
                    'sort_order' => 6,
                ],
