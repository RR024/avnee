...
<div class="bg-[#1a0025] border-b border-[#4f006a]">
    <div class="max-w-7xl mx-auto px-4 py-3">
        <nav class="flex items-center gap-2 text-xs text-[#e9d5ff] font-semibold uppercase tracking-widest">
            <a href="<?php echo e(route('front.home')); ?>" class="hover:text-[#d4af37] transition-colors">Home</a>
            <span class="opacity-40">/</span>
            <a href="<?php echo e(route('front.products.index', ['collection' => 'organizers'])); ?>" class="hover:text-[#d4af37] transition-colors">Organizers</a>
            <span class="opacity-40">/</span>
            <span class="text-[#d4af37] truncate max-w-[180px]"><?php echo e($title); ?></span>
        </nav>
    </div>
</div>
...
<div class="bg-[#230030] min-h-screen">
            ...
            <div class="flex flex-row gap-3 lg:gap-4" id="product-gallery">
                ...
                <div class="flex flex-col gap-2 flex-shrink-0 w-[64px] lg:w-[80px]" id="thumb-rail">
                    <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button
                            type="button"
                            class="thumb-btn block border-2 rounded-md overflow-hidden aspect-[3/4] transition-all duration-200 <?php echo e($idx === 0 ? 'border-[#d4af37]' : 'border-[#4f006a] hover:border-[#d4af37]'); ?>"
                            data-index="<?php echo e($idx); ?>"
                            data-src="<?php echo e($img); ?>"
                            onclick="selectImage(<?php echo e($idx); ?>, '<?php echo e($img); ?>')"
                        >
                            <img src="<?php echo e($img); ?>" alt="View <?php echo e($idx + 1); ?>" class="w-full h-full object-cover" onerror="this.onerror=null;this.src='<?php echo e(asset('images/hero-slider/3.png')); ?>';" />
                        </button>
                ...
                <div class="relative flex-1 aspect-[3/4] overflow-hidden rounded-xl border border-[#4f006a] bg-[#350047] group">
                    ...
                    <img
                        ...
                        onerror="this.onerror=null;this.src='<?php echo e(asset('images/hero-slider/3.png')); ?>';"
                    />
                    ...
                    <div class="absolute bottom-3 right-3 bg-black/60 text-white text-xs px-2.5 py-1 rounded-full font-bold tracking-wide" id="img-counter">
                        1 / <?php echo e(count($galleryImages)); ?>
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h1 class="text-xl lg:text-3xl font-black uppercase tracking-wide text-[#fdf2f8] leading-tight"><?php echo e($title); ?></h1>
                    </div>
                ...
                <p class="text-xs font-semibold tracking-widest text-[#e9d5ff] opacity-60 uppercase">Style No: <?php echo e($styleNo); ?></p>

                
                <div>
                    <?php if($comparePrice > $price): ?>
                        <p class="text-sm text-[#e9d5ff] line-through opacity-50 font-medium">₹<?php echo e(number_format($comparePrice, 0)); ?></p>
                    <?php endif; ?>
                    <p class="text-3xl font-black text-[#fdf2f8] tracking-tight">₹<?php echo e(number_format($price, 0)); ?></p>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button type="button" class="flex-1 h-11 bg-[#350047] border border-[#d4af37] text-[#d4af37] text-sm font-black uppercase tracking-widest hover:bg-[#d4af37] hover:text-[#1a0025] transition-all rounded-sm">
                        ADD TO CART &bull; ₹<?php echo e(number_format($price, 0)); ?>
                ...
                <a href="<?php echo e(route('front.products.index', ['collection' => 'organizers'])); ?>" class="text-xs font-black uppercase tracking-[0.25em] text-[#d4af37] hover:opacity-70 transition">
                    ← Back to Organizers
                </a>
    ...
    <section class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-5">
            <?php $__currentLoopData = $similarProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sim): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <div class="group relative flex flex-col">
                    <a href="<?php echo e($simUrl); ?>" class="relative block overflow-hidden bg-[#350047] aspect-[3/4] border border-[#4f006a] rounded-lg hover:border-[#d4af37]/50 transition-colors">
                        <?php if(!empty($sim['discount'])): ?>
                            <div class="absolute top-2 left-2 z-10 bg-white text-black text-[10px] font-black px-2 py-0.5 tracking-widest uppercase">-<?php echo e($sim['discount']); ?>%</div>
                        <?php endif; ?>
                        <img src="<?php echo e($sim['image']); ?>" alt="<?php echo e($sim['title']); ?>" class="w-full h-full object-cover object-top transition-transform duration-[2.5s] group-hover:scale-110" onerror="this.onerror=null;this.src='<?php echo e(asset('images/hero-slider/3.png')); ?>';" />
                    </a>
                    <div class="pt-3">
                        <a href="<?php echo e($simUrl); ?>" class="block">
                            <h3 class="text-xs font-semibold text-[#fdf2f8] uppercase tracking-wide line-clamp-2 hover:text-[#d4af37] transition-colors"><?php echo e($sim['title']); ?></h3>
                        </a>
                        <p class="text-sm font-bold text-[#fdf2f8] mt-1">₹<?php echo e(number_format($sim['price'], 0)); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-5" id="recently-viewed-grid">
            ...
            <div class="group relative flex flex-col">
                <a href="#" class="relative block overflow-hidden bg-[#350047] aspect-[3/4] border border-[#4f006a] rounded-lg hover:border-[#d4af37]/50 transition-colors">
                    <img src="<?php echo e($mainImage); ?>" alt="<?php echo e($title); ?>" class="w-full h-full object-cover object-top transition-transform duration-[2.5s] group-hover:scale-110" onerror="this.onerror=null;this.src='<?php echo e(asset('images/hero-slider/3.png')); ?>';" />
                </a>
                <div class="pt-3">
                    <h3 class="text-xs font-semibold text-[#fdf2f8] uppercase tracking-wide line-clamp-2"><?php echo e(\Illuminate\Support\Str::limit($title, 28)); ?></h3>
                    <p class="text-sm font-bold text-[#fdf2f8] mt-1">₹<?php echo e(number_format($price, 0)); ?></p>
                </div>
            </div>
        </div>
    </section>
...
<script>
(function () {
    const images = <?php echo json_encode($galleryImages, 15, 512) ?>;
    let current = 0;
...
<?php echo $__env->make('layouts.front.jewellery', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/front/demo-product.blade.php ENDPATH**/ ?>