<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-[1440px] mx-auto">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.collection', ['collection' => 'sale'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/1.png')); ?>" alt="Jewellery Sale" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.index', ['category' => 'hair-accessories'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/2.png')); ?>" alt="Hair Accessories Sale" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.index', ['category' => 'jewellery-gallery'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/3.png')); ?>" alt="Kids Jewellery Sale" class="w-full h-full object-cover" />
          </a>
        </div>
      </div>
  ...
  <section id="home-featured-collections" class="py-10 sm:py-14 bg-[#2B003A] border-y border-[#4f006a]">
    <div class="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 lg:gap-4">
        <?php $__currentLoopData = $featuredCollectionCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e(route('front.jewellery.collection.show', $card['slug'])); ?>" class="group block border border-[#4f006a] bg-[#350047] p-1.5 shadow-sm hover:shadow-md transition-shadow duration-300">
            <div class="relative overflow-hidden aspect-[3/4]">
              <img src="<?php echo e($card['image']); ?>" alt="<?php echo e($card['title']); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" />
            </div>
            <div class="px-2 py-3 text-center bg-[#2B003A] border-t border-[#4f006a]">
              <h3 class="text-sm sm:text-base font-semibold text-[#f3d9ff] tracking-wide"><?php echo e($card['title']); ?></h3>
            </div>
          </a>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative group">
        ...
        <div class="swiper trending-now-swiper overflow-hidden px-1">
          <div class="swiper-wrapper">
            <?php $__currentLoopData = $trendingSlides; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slide): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide h-auto">
              <article class="bg-[#350047] border border-[#4f006a] p-2 sm:p-3 h-[400px] flex flex-col relative">
                <a href="<?php echo e($slide['link']); ?>" class="block relative bg-[#2B003A] h-[230px] overflow-hidden border border-[#4f006a]">
                  <?php if($slide['discount'] > 0): ?>
                <span class="absolute top-2 left-2 z-10 bg-[#f3d9ff] text-[#2B003A] text-xs px-3 py-1">Sale</span>
                  <?php endif; ?>
                  <img src="<?php echo e($slide['image']); ?>" alt="<?php echo e($slide['name']); ?>" class="w-full h-full object-cover transition-transform duration-500 hover:scale-105" loading="lazy" />
                </a>
                <?php if($slide['is_product'] && $slide['product_id']): ?>
                  <button
                    type="button"
                    class="wishlist-btn absolute top-5 right-5 z-20 h-9 w-9 rounded-full border border-white/70 bg-white/90 text-gray-700 shadow-sm backdrop-blur transition hover:scale-105 hover:bg-white <?php echo e($slide['is_wishlisted'] ? 'text-red-500' : ''); ?>"
                    data-product-id="<?php echo e($slide['product_id']); ?>"
                    aria-label="Add to wishlist"
                    title="Add to wishlist"
                  >
                    <svg class="wishlist-icon mx-auto h-4 w-4 <?php echo e($slide['is_wishlisted'] ? 'fill-current' : ''); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
                    </svg>
                  </button>
                <?php endif; ?>
                <div class="pt-4 px-2 pb-2 text-center flex-1 flex flex-col">
                  <a href="<?php echo e($slide['link']); ?>" class="block">
                    <h3 class="font-heading text-lg sm:text-xl leading-[1.2] text-black line-clamp-2 h-[2.2rem] flex items-center justify-center"><?php echo e($slide['name']); ?></h3>
                  </a>
                  <div class="mt-2.5 flex items-center justify-center gap-2 flex-wrap">
                    <span class="text-black text-xl sm:text-2xl font-bold">₹<?php echo e(number_format($slide['price'], 2)); ?></span>
                    <?php if($slide['compare_price'] > $slide['price']): ?>
                      <span class="text-gray-600 text-lg sm:text-xl line-through">₹<?php echo e(number_format($slide['compare_price'], 2)); ?></span>
                    <?php endif; ?>
                  </div>
                  <?php if($slide['discount'] > 0): ?>
                    <p class="text-black text-base sm:text-lg mt-2 font-medium"><?php echo e($slide['discount']); ?>% OFF</p>
                  <?php endif; ?>
                  <div class="mt-auto pt-3">
                    <a href="<?php echo e($slide['link']); ?>" class="inline-flex items-center justify-center w-full h-10 bg-[#d4af37] text-[#2B003A] text-base sm:text-lg tracking-[0.08em] uppercase rounded-[3px] hover:bg-[#f3d9ff] transition-colors">Shop Now</a>
                  </div>
                </div>
              </article>
            </div>
  ...
  <section id="shop-by-price-static" class="py-12 sm:py-16 bg-[#2B003A]">
    <div class="max-w-[1320px] mx-auto px-3 sm:px-4 lg:px-6">
      ...
      <div class="flex flex-wrap justify-center gap-6 sm:gap-10 lg:gap-16">
        ...
        <a href="<?php echo e($band['url']); ?>" class="price-badge-wrap group relative flex shrink-0 items-center justify-center">
          ...
          <div class="relative z-10 flex min-w-0 w-full flex-col items-center justify-center px-1 text-center">
            <span class="price-badge-label font-heading italic text-[#F8C8DC]/80 text-[10px] sm:text-xs lg:text-base uppercase tracking-[0.2em] mb-0 sm:mb-1"><?php echo e($band['label']); ?></span>
            <span class="price-badge-value font-heading text-2xl sm:text-3xl lg:text-4xl font-bold tabular-nums text-pastel-pink tracking-wider whitespace-nowrap leading-tight">₹<?php echo e($band['price']); ?></span>
          </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
  ...
  <section id="shop-by-style-static" class="py-12 sm:py-16 bg-[#2B003A]">
    <div class="w-full px-3 sm:px-4 lg:px-8 xl:px-10">
      ...
      <div class="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-x-5 sm:gap-x-7 lg:gap-x-10 xl:gap-x-12 gap-y-5 sm:gap-y-6">
        <?php $__currentLoopData = $styleCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $styleCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php
          ...
          ?>
          <a href="<?php echo e(route('front.products.index', ['category' => $styleCard['slug'], 'force_theme' => 'jewellery'])); ?>" class="group block text-center">
            <div class="aspect-[4/5] bg-[#350047] overflow-hidden shadow-sm border border-[#d4af37]/35 hover:shadow-lg transition-all duration-300">
              <img src="<?php echo e($styleImageSrc); ?>" alt="<?php echo e($styleCard['label']); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" loading="lazy" />
            </div>
            <p class="mt-2 text-sm sm:text-base text-[#f1d58a] font-medium tracking-wide"><?php echo e($styleCard['label']); ?></p>
          </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
  ...
  <?php if($activeFlashSale && $activeFlashSale->products->isNotEmpty()): ?>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="font-heading text-2xl sm:text-3xl font-normal tracking-[0.1em] text-white uppercase decoration-[#f3d9ff]/30 underline underline-offset-[8px]"><?php echo e($activeFlashSale->title); ?></h2>
            <p class="text-[#e9d5ff] text-sm font-medium">Limited time offers end in:</p>
          </div>
        </div>
        <div class="flex gap-4 sm:gap-6" id="flash-countdown" data-expire="<?php echo e($activeFlashSale->end_time->toIso8601String()); ?>">
      ...
      <div class="relative group">
        ...
        <div class="swiper flash-swiper overflow-hidden px-1">
          <div class="swiper-wrapper">
            <?php $__currentLoopData = $activeFlashSale->products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="swiper-slide">
              <div class="group bg-[#350047] rounded-sm overflow-hidden border border-[#4f006a] hover:border-[#f3d9ff] transition-all shadow-lg">
                  <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="relative block bg-[#230030] aspect-[3/4]">
                      <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
                      <?php $discountPct = $product->pivot->discount_percentage ?? $product->discount; ?>
                  ...
                  <div class="p-3">
                      <h3 class="text-xs font-medium text-[#e9d5ff] line-clamp-1 mb-2 hover:text-[#f3d9ff] transition-colors"><?php echo e($product->name); ?></h3>
                      <div class="flex items-center gap-2">
                          <span class="text-sm font-bold text-[#f3d9ff]">₹<?php echo e(number_format($product->price, 2)); ?></span>
                          <?php if($product->compare_price > $product->price): ?>
                          <span class="text-xs text-[#c0a0c0] line-through">₹<?php echo e(number_format($product->compare_price, 2)); ?></span>
                          <?php endif; ?>
                      </div>
                  </div>
              </div>
  ...
  <?php if(isset($combos) && $combos->count() > 0): ?>
  <div class="golden-separator"></div>
  <section id="combo-deals" class="py-16 sm:py-24 bg-[#230030] border-b border-[#4f006a]">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row justify-between items-center mb-14 gap-8 text-center md:text-left">
            ...
            <a href="<?php echo e(route('front.products.index')); ?>" class="group flex items-center gap-4 text-xs font-bold uppercase tracking-[0.3em] text-white hover:text-[#f3d9ff] transition-all">
                The Full Collection
                    ...
                    <div class="swiper-slide h-auto pb-4">
                        <div class="group relative flex flex-col bg-[#2B003A] rounded-sm overflow-hidden border border-[#4f006a] hover:border-[#f3d9ff]/30 transition-all duration-700 h-full shadow-2xl mx-1">
                            <div class="relative aspect-[4/3] overflow-hidden">
                                <?php if($combo->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $combo->image)); ?>" alt="<?php echo e($combo->title); ?>" class="w-full h-full object-cover transition-transform duration-[2s] group-hover:scale-110" />
                                <?php else: ?>
                                    <img src="<?php echo e(asset('storage/' . $combo->products->first()->image)); ?>" alt="<?php echo e($combo->title); ?>" class="w-full h-full object-cover brightness-[0.8] transition-transform duration-[2s] group-hover:scale-110" />
                                <?php endif; ?>
                                <?php if($combo->original_price > $combo->price): ?>
                            ...
                            <div class="px-8 pb-8 flex-1 flex flex-col -mt-10 relative z-10">
                                <div class="mb-8 flex-1">
                                    <h3 class="font-heading text-2xl text-white mb-5 group-hover:text-[#f3d9ff] transition-colors uppercase tracking-widest leading-tight line-clamp-2"><?php echo e($combo->title); ?></h3>
                                    <div class="flex items-center gap-4">
                                        <div class="flex -space-x-4 overflow-hidden">
                                            <?php $__currentLoopData = $combo->products->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="inline-block h-14 w-14 rounded-full ring-4 ring-[#2B003A] overflow-hidden border border-[#4f006a]">
                                                    <img src="<?php echo e(asset('storage/' . $cp->image)); ?>" class="h-full w-full object-cover" />
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <span class="text-[10px] font-bold text-[#a8998a] uppercase tracking-[0.2em]"><?php echo e($combo->products->count()); ?> Piece Set</span>
                                    </div>
                                </div>
                                <div class="flex items-center justify-between pt-8 border-t border-[#4f006a]">
                                    <div class="flex flex-col">
                                        <div class="flex items-center gap-2 mb-1">
                                            <span class="text-3xl font-bold text-white tracking-tighter">₹<?php echo e(number_format($combo->price, 0)); ?></span>
                                            <?php if($combo->original_price > $combo->price): ?>
                                                <span class="text-[10px] bg-red-900/40 text-red-400 px-2 py-0.5 rounded uppercase font-bold tracking-tight">SAVE ₹<?php echo e(number_format($combo->original_price - $combo->price, 0)); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if($combo->original_price): ?>
                                            <span class="text-xs text-[#c0a0c0] line-through tracking-wider">MSRP: ₹<?php echo e(number_format($combo->original_price, 2)); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <button type="button" onclick="openComboModal('<?php echo e($combo->id); ?>', '<?php echo e(number_format($combo->price, 2)); ?>');"
  ...
  <?php $loopSections = $homeSections->sortBy('sort_order'); ?>
  <?php $__currentLoopData = $loopSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    
    <?php if(($section->section_id === 'just_in_jewellery' || $section->section_id === 'just_in') && $section->is_active): ?>
      <section id="just-in" class="py-10 sm:py-14 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
          <?php $__currentLoopData = $justInExperiences->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e($exp->button_link); ?>" class="group relative block overflow-hidden aspect-[4/5] bg-[#350047] rounded-sm border border-[#4f006a]">
            <img src="<?php echo e(asset('storage/' . $exp->image)); ?>" alt="<?php echo e($exp->title); ?>" class="w-full h-full object-cover object-top transition-transform duration-700 ease-in-out group-hover:scale-110" />
            <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/10 to-transparent"></div>
            <div class="absolute bottom-0 inset-x-0 p-3 text-center">
              <p class="font-heading text-base sm:text-lg font-semibold text-white tracking-wide truncate"><?php echo e($exp->title); ?></p>
    ...
    <?php if(($section->section_id === 'shop_by_price_jewellery' || $section->section_id === 'shop_by_price') && $section->is_active): ?>
      <?php
      ...
      <section id="shop-by-price" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto bg-white">
        ...
        <div class="flex flex-wrap justify-center gap-6 sm:gap-10 lg:gap-16">
          <?php $__currentLoopData = $renderPriceBands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $band): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e($band['url']); ?>" class="price-badge-wrap group relative flex shrink-0 items-center justify-center">
            <svg class="absolute inset-0 w-full h-full drop-shadow-xl badge-svg transition-transform duration-500 group-hover:scale-110" viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet">
              <path class="scallop-fill fill-mulberry" d="M100,12 A88,88 0 1,1 99.99,12 Z" />
              <path class="scallop-stroke fill-none stroke-pastel-pink/30" stroke-width="1.5" d="M100,21 A79,79 0 1,1 99.99,21 Z" />
            ...
            <div class="relative z-10 flex min-w-0 w-full flex-col items-center justify-center px-1 text-center">
              <span class="font-heading italic text-[#F8C8DC]/80 text-[10px] sm:text-xs lg:text-base uppercase tracking-[0.2em] mb-0 sm:mb-1"><?php echo e($band['label']); ?></span>
              <span class="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold tabular-nums text-pastel-pink tracking-wider whitespace-nowrap leading-tight">₹<?php echo e(preg_replace('/[^0-9]/', '', (string) $band['price']) ?: $band['price']); ?></span>
            </div>
          </a>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    ...
    <?php if($section->section_id === 'shop_by_style' && $section->is_active): ?>
      <section id="shop-by-style" class="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto bg-[#2B003A]">
        ...
        <div class="relative group">
          ...
          <div class="swiper style-swiper overflow-hidden">
            <div class="swiper-wrapper">
              <?php $__currentLoopData = $homeStyles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="swiper-slide px-1">
                <div class="flex flex-col items-center group text-center">
                  <a href="<?php echo e($style->redirect_url); ?>" class="relative w-full aspect-square overflow-hidden rounded-sm bg-white mb-4 transition-all duration-500 hover:shadow-2xl shadow-lg p-4 group/img border border-gray-100/50">
                    <img src="<?php echo e(asset('storage/' . $style->image)); ?>" alt="<?php echo e($style->title); ?>" class="w-full h-full object-cover rounded-sm transition-transform duration-700 group-hover/img:scale-105" />
                  </a>
                  <h3 class="text-[10px] sm:text-xs font-bold text-[#f3d9ff] uppercase tracking-[0.2em] group-hover:text-white transition-colors leading-tight px-1"><?php echo e($style->title); ?></h3>
                </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
    ...
    <?php if(($section->section_id === 'best_buys_jewellery' || $section->section_id === 'best_buys') && $section->is_active): ?>
      <section id="best-buys" class="py-12 sm:py-16 max-w-[1440px] mx-auto px-2 sm:px-4 lg:px-6">
        ...
        <div class="relative">
          ...
          <div class="swiper best-buys-swiper overflow-hidden px-1">
            <div class="swiper-wrapper">
              ...
              ?>
              <?php $__currentLoopData = $bestBuyProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="swiper-slide">
                <div class="group bg-[#350047]">
                  <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="relative block overflow-hidden bg-[#f5ede0]" style="aspect-ratio: 3/4;">
                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover object-top transition-transform duration-500 group-hover:scale-105" />
                  </a>
                  <button
                    type="button"
                    class="wishlist-btn absolute top-3 right-3 z-20 h-9 w-9 rounded-full border border-white/70 bg-white/90 text-gray-700 shadow-sm backdrop-blur transition hover:scale-105 hover:bg-white <?php echo e($product->is_wishlisted ? 'text-red-500' : ''); ?>"
                  ...
                  <div class="pt-3 pb-1 px-1">
                    <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>">
                      <p class="text-xs text-[#e9d5ff] leading-snug line-clamp-2 mb-2 hover:text-[#f3d9ff] transition-colors"><?php echo e($product->name); ?></p>
                    </a>
                    <div class="flex items-center gap-2 flex-wrap">
                      <span class="text-sm font-semibold text-[#f3d9ff]">₹<?php echo e(number_format($product->price, 0)); ?></span>
                      <?php if($product->compare_price > $product->price): ?>
                      <span class="text-[10px] text-[#c0a0c0] line-through">₹<?php echo e(number_format($product->compare_price, 0)); ?></span>
                      <span class="text-[9px] font-black text-white bg-red-600 px-1 rounded-sm"><?php echo e(round((($product->compare_price - $product->price) / $product->compare_price) * 100)); ?>% OFF</span>
                      <?php endif; ?>
                    </div>
                  </div>
                </div>
        ...
        <div class="mt-6 flex justify-center">
          <a href="<?php echo e(route('front.products.index')); ?>" class="px-6 py-2 text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] bg-[#f3d9ff] text-[#2B003A] hover:bg-white transition-colors rounded-full">View All</a>
        </div>
      </section>
    <?php endif; ?>

    
    <?php if(($section->section_id === 'shop_the_look_jewellery' || $section->section_id === 'shop_the_look') && $section->is_active): ?>
      <section id="shop-the-look" class="py-12 sm:py-24 bg-[#2B003A] overflow-hidden relative">
        ...
        <div class="relative max-w-[1600px] mx-auto px-4 sm:px-10 lg:px-20 group">
          ...
          <div id="shop-look-swiper" class="swiper pb-20">
            <div class="swiper-wrapper">
              <?php $items = $section->products->take($section->limit); ?>
              
              <?php $__currentLoopData = $items->concat($items); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="swiper-slide">
                <div class="look-card bg-white/5 rounded-[40px] overflow-hidden p-3 sm:p-5 border border-white/10 backdrop-blur-md transition-all duration-500 scale-[0.65] opacity-20 [.swiper-slide-active_&]:scale-100 [.swiper-slide-active_&]:opacity-100 [.swiper-slide-prev_&]:scale-[0.80] [.swiper-slide-prev_&]:opacity-70 [.swiper-slide-next_&]:scale-[0.80] [.swiper-slide-next_&]:opacity-70">
                  <div class="relative aspect-[4/5] rounded-[32px] overflow-hidden group">
                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover object-top transition-transform duration-1000 group-hover:scale-110" />
                  ...
                  <div class="mt-6 text-center space-y-4 pb-2">
                    <h3 class="text-xl sm:text-2xl font-normal text-[#f3d9ff] tracking-tight line-clamp-1 truncate px-4"><?php echo e($product->name); ?></h3>
                    <div class="flex justify-center">
                      <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="inline-block bg-[#d4af37] text-[#1a0023] text-[11px] font-bold uppercase tracking-[0.2em] px-10 py-3 rounded-full hover:scale-105 active:scale-95 transition-all">
                        View
                      </a>
                    </div>
                  </div>
    ...
    <?php if(($section->section_id === 'top_collections_jewellery' || $section->section_id === 'top_collections') && $section->is_active): ?>
      <section id="top-collections" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto">
        ...
        <div class="relative group">
          ...
          <div class="swiper top-col-swiper overflow-hidden">
            <div class="swiper-wrapper">
              <?php $__currentLoopData = $section->products->take($section->limit); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="swiper-slide px-1">
                <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="top-col-card block group bg-[#2B003A] relative overflow-hidden" style="aspect-ratio: 1/1.1;">
                  <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105" />
                  <div class="top-col-overlay absolute inset-0 flex flex-col justify-end p-6 sm:p-8">
                    <h3 class="font-heading text-2xl sm:text-3xl font-semibold text-white mb-1 uppercase tracking-wider"><?php echo e($product->name); ?></h3>
    ...
    <?php if(($section->section_id === 'popular_pieces_jewellery' || $section->section_id === 'popular_pieces') && $section->is_active): ?>
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="group relative">
                    <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="block aspect-[3/4] bg-[#2B003A] overflow-hidden">
                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
                    </a>
                    <button
                        type="button"
                        class="wishlist-btn absolute top-3 right-3 z-20 h-9 w-9 rounded-full border border-white/70 bg-white/90 text-gray-700 shadow-sm backdrop-blur transition hover:scale-105 hover:bg-white <?php echo e($product->is_wishlisted ? 'text-red-500' : ''); ?>"
                    ...
                    <div class="pt-4 px-1">
                        <h3 class="text-[11px] font-bold text-black uppercase tracking-wider mb-1 truncate"><?php echo e($product->name); ?></h3>
                        <p class="text-xs font-bold text-black">₹<?php echo e(number_format($product->price, 0)); ?></p>
                    </div>
                </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
  ...
  <section id="crafted-love-video" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8" style="background: radial-gradient(circle at 20% 20%, rgba(255,180,120,0.22), transparent 30%), radial-gradient(circle at 80% 20%, rgba(255,180,120,0.2), transparent 28%), radial-gradient(circle at 20% 80%, rgba(255,180,120,0.16), transparent 30%), radial-gradient(circle at 80% 80%, rgba(255,180,120,0.18), transparent 32%), linear-gradient(180deg, #4a0f47 0%, #2d0037 50%, #3a003f 100%);">
    <div class="max-w-[1200px] mx-auto text-center">
      ...
      <div class="relative rounded-3xl overflow-hidden border-4 border-[#f0b77d] shadow-[0_0_40px_rgba(255,180,110,0.35)]">
        <img src="<?php echo e($craftedVideoPoster); ?>" alt="Crafted with Love" class="w-full aspect-[16/9] object-cover" />
        <div class="absolute inset-0 bg-black/25"></div>
        <button type="button" id="crafted-video-play" data-video-src="<?php echo e($craftedVideoSrc); ?>" class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 inline-flex items-center gap-4 rounded-full border-2 border-[#f0c58f] bg-[#2a0e34]/70 px-6 sm:px-10 py-3 sm:py-4 text-[#f8d9aa] font-heading text-2xl sm:text-5xl uppercase tracking-[0.03em] hover:bg-[#3a1545]/80 transition-colors">
      ...
      <a href="<?php echo e(route('front.sale.jewellery')); ?>" class="mt-7 inline-flex items-center justify-center rounded-lg border border-[#f0c58f] bg-[#f0c58f] px-8 sm:px-14 py-3 text-[#4a1d22] font-heading text-2xl sm:text-4xl tracking-[0.03em] uppercase hover:bg-[#ffd9a8] transition-colors">
        Shop Collection
      </a>
    </div>
  </section>
  ...
  <section id="home-lookbook-jewellery" class="py-10 sm:py-14 bg-[#f2f2f2] border-t border-b border-gray-200">
    ...
    <div class="relative max-w-[1440px] mx-auto px-2 sm:px-8" id="lookbook-stage-wrap-jw">
      ...
      <div id="lookbook-stage-jw" class="lookbook-stage-jw pb-8">
        <?php $__currentLoopData = [-2, -1, 0, 1, 2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="look-slot-jw" data-slot="<?php echo e($slot); ?>">
      ...
      <div class="border border-[#b8894d]/70 rounded-[28px] px-6 sm:px-10 py-8 sm:py-10" style="background: rgba(26, 0, 38, 0.7); box-shadow: 0 20px 60px rgba(17, 0, 29, 0.45);">
        ...
        <div class="relative mt-8">
          ...
          <div class="grid gap-4 sm:gap-6 md:grid-cols-3" id="handcrafted-track">
            <?php $__currentLoopData = $handcraftedPicks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pick): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <article class="handcrafted-card hidden" data-title="<?php echo e($pick['title']); ?>" data-image="<?php echo e($pick['image']); ?>" data-slug="<?php echo e($pick['slug']); ?>">
                <div class="rounded-2xl border border-[#b8894d]/60 bg-[#2a0038] p-3 sm:p-4 shadow-[0_12px_32px_rgba(15,0,25,0.35)]">
                  <div class="relative overflow-hidden rounded-xl border border-[#7f4a6a]">
                    <img src="<?php echo e($pick['image']); ?>" alt="<?php echo e($pick['title']); ?>" class="w-full aspect-[3/4] object-cover" />
                  </div>
                  <p class="mt-4 text-center text-lg sm:text-xl text-[#f7d7aa] font-heading"><?php echo e($pick['title']); ?></p>
                  <a href="<?php echo e(route('front.products.index', ['category' => $pick['slug'], 'force_theme' => 'jewellery'])); ?>" class="mt-3 inline-flex items-center justify-center w-full rounded-md border border-[#f0c58f] bg-[#f0c58f] px-4 py-2 text-[#2a0e34] text-sm sm:text-base font-semibold uppercase tracking-[0.08em] hover:bg-[#ffd9a8] transition-colors">View Product</a>
                </div>
              </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
  ...
  <?php if(isset($brandExperiences) && $brandExperiences->isNotEmpty()): ?>
  <section id="brand-experiences" class="py-0 max-w-[1440px] mx-auto px-0 relative group bg-[#2B003A]">
    ...
    <div class="swiper brand-experience-swiper h-full">
      <div class="swiper-wrapper h-full">
        <?php $__currentLoopData = $brandExperiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="swiper-slide h-auto flex items-center justify-center py-8">
          <div class="bg-[#2B003A] w-full max-w-[1240px] mx-auto p-6 sm:p-12 lg:p-16 relative">
            <h2 class="font-heading text-xl sm:text-2xl text-center text-[#f3d9ff]/50 font-normal tracking-[0.3em] mb-6 sm:mb-10 uppercase"><?php echo e($exp->title); ?></h2>
            <?php if($exp->layout_type == 'layout_1'): ?>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center">
                ...
                <div class="lg:col-span-4">
                  <div class="relative group/img overflow-hidden rounded-sm shadow-2xl border border-[#4f006a]">
                    <img src="<?php echo e(asset('storage/'.$exp->image_1)); ?>" class="w-full aspect-[3/4] object-cover transition-transform duration-1000 group-hover/img:scale-105" />
                    <?php if($exp->image_1_label): ?>
                      <p class="mt-4 text-center text-sm font-medium text-[#f3d9ff] tracking-wide uppercase"><?php echo e($exp->image_1_label); ?></p>
                    <?php endif; ?>
                  </div>
                </div>
                ...
                <div class="lg:col-span-3 space-y-8">
                  <?php if($exp->image_2): ?>
                    <div class="relative group/img overflow-hidden rounded-sm shadow-xl border border-[#4f006a]">
                      <img src="<?php echo e(asset('storage/'.$exp->image_2)); ?>" class="w-full aspect-square object-cover transition-transform duration-1000 group-hover/img:scale-105" />
                      <?php if($exp->image_2_label): ?>
                        <p class="mt-3 text-center text-xs font-medium text-[#e9d5ff]/70 uppercase"><?php echo e($exp->image_2_label); ?></p>
                      <?php endif; ?>
                    </div>
                  <?php endif; ?>
                  <?php if($exp->image_3): ?>
                    <div class="relative group/img overflow-hidden rounded-sm shadow-xl border border-[#4f006a]">
                      <img src="<?php echo e(asset('storage/'.$exp->image_3)); ?>" class="w-full aspect-[4/3] object-cover transition-transform duration-1000 group-hover/img:scale-105" />
                      <?php if($exp->image_3_label): ?>
                        <p class="mt-3 text-center text-xs font-medium text-[#e9d5ff]/70 uppercase"><?php echo e($exp->image_3_label); ?></p>
                      <?php endif; ?>
                    </div>
                  <?php endif; ?>
                </div>
                ...
                <div class="lg:col-span-5 text-left lg:pl-8 flex flex-col justify-center">
                  <h3 class="font-heading text-4xl sm:text-5xl font-normal text-white mb-6 leading-tight drop-shadow-lg"><?php echo e($exp->content_title); ?></h3>
                  <p class="text-[#e9d5ff] text-base leading-relaxed mb-10 font-light italic"><?php echo e($exp->content_description); ?></p>
                  <a href="<?php echo e($exp->button_link); ?>" class="group/btn inline-flex items-center gap-4 bg-[#f3d9ff] text-[#2B003A] text-[10px] font-black tracking-[0.3em] uppercase px-12 py-5 hover:bg-white transition-all shadow-xl rounded-sm">
                    <?php echo e($exp->button_text); ?>

                    <span class="material-symbols-outlined text-sm transition-transform group-hover/btn:translate-x-1">north_east</span>
                  </a>
                </div>
              </div>
            <?php elseif($exp->layout_type == 'layout_2'): ?>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                ...
                <div class="lg:col-span-7 text-left order-2 lg:order-1 flex flex-col justify-center py-10">
                   <h3 class="font-heading text-4xl sm:text-5xl font-normal text-white mb-6 leading-tight drop-shadow-lg"><?php echo e($exp->content_title); ?></h3>
                   <p class="text-[#e9d5ff] text-base leading-relaxed mb-10 font-light italic"><?php echo e($exp->content_description); ?></p>
                   <a href="<?php echo e($exp->button_link); ?>" class="group/btn inline-flex items-center gap-4 bg-[#f3d9ff] text-[#2B003A] text-[10px] font-black tracking-[0.3em] uppercase px-12 py-5 hover:bg-white transition-all shadow-xl rounded-sm w-max">
                     <?php echo e($exp->button_text); ?>
                ...
                <div class="lg:col-span-5 grid grid-cols-2 gap-6 sm:gap-8 order-1 lg:order-2">
                  <?php $__currentLoopData = ['image_1', 'image_2', 'image_3', 'image_4']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $imgField = $idx; $labelField = $idx.'_label'; ?>
                    <?php if($exp->$imgField): ?>
                    <div class="space-y-3">
                      <div class="relative overflow-hidden rounded-sm shadow-xl border border-[#4f006a] group/img">
                         <img src="<?php echo e(asset('storage/'.$exp->$imgField)); ?>" class="w-full aspect-square object-cover transition-transform duration-1000 group-hover/img:scale-110" />
                      </div>
                      <?php if($exp->$labelField): ?>
                        <p class="text-[8px] sm:text-[10px] font-bold text-[#e9d5ff]/50 uppercase tracking-widest text-center mt-3"><?php echo e($exp->$labelField); ?></p>
                      <?php endif; ?>
                    </div>
                    <?php endif; ?>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php else: ?>
              ...
              <div class="flex flex-col lg:flex-row items-stretch h-full overflow-hidden">
                ...
                <div class="w-full lg:w-[58%] p-0 lg:pr-10 h-auto">
                  <div class="grid grid-cols-[3.8fr_5fr] gap-3 sm:gap-4 lg:gap-5 h-full">
                    <div class="relative bg-black overflow-hidden rounded-sm min-h-[300px]">
                      <?php if($exp->image_1 && (str_ends_with($exp->image_1, '.mp4') || str_ends_with($exp->image_1, '.mov'))): ?>
                        <video src="<?php echo e(asset('storage/'.$exp->image_1)); ?>" class="absolute inset-0 w-full h-full object-cover object-top" autoplay muted loop playsinline></video>
                      <?php else: ?>
                        <img src="<?php echo e(asset('storage/'.$exp->image_1)); ?>" class="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-1000 hover:scale-110" />
                      <?php endif; ?>
                    </div>
                    <div class="flex flex-col gap-3 sm:gap-4 lg:gap-5">
                      <div class="relative w-full pb-[80%] bg-black overflow-hidden rounded-sm">
                        <?php if($exp->image_2): ?>
                          <img src="<?php echo e(asset('storage/'.$exp->image_2)); ?>" class="absolute inset-0 w-full h-full object-cover object-center transition-transform duration-1000 hover:scale-110" />
                        <?php endif; ?>
                      </div>
                      <div class="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-5 flex-1">
                        ...
                        <div class="relative w-full bg-black overflow-hidden rounded-sm min-h-[150px]">
                          <img src="<?php echo e(asset('storage/'.$exp->image_3)); ?>" class="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-1000 hover:scale-110" />
                        </div>
                        <?php endif; ?>
                        <?php if($exp->image_4): ?>
                        <div class="relative w-full bg-black overflow-hidden rounded-sm min-h-[150px]">
                          <img src="<?php echo e(asset('storage/'.$exp->image_4)); ?>" class="absolute inset-0 w-full h-full object-cover object-top transition-transform duration-1000 hover:scale-110" />
                        </div>
                        <?php endif; ?>
                      </div>
                    </div>
                ...
                <div class="w-full lg:w-[42%] flex flex-col items-center lg:items-start justify-center p-8 lg:p-14 text-center lg:text-left">
                  <p class="font-heading italic text-2xl text-[#f3d9ff] mb-2 opacity-80 underline underline-offset-8 decoration-[#f3d9ff]/30"><?php echo e($exp->content_title); ?></p>
                  <h3 class="font-heading text-4xl sm:text-5xl lg:text-6xl font-normal tracking-[0.1em] text-white uppercase mb-6 leading-tight"><?php echo e($exp->title); ?></h3>
                  <p class="text-[#e9d5ff] text-base leading-relaxed mb-10 max-w-sm font-light italic"><?php echo e($exp->content_description); ?></p>
                  <a href="<?php echo e($exp->button_link); ?>" class="group/btn inline-flex items-center gap-4 bg-[#f3d9ff] text-[#2B003A] text-[10px] font-black tracking-[0.3em] uppercase px-12 py-5 hover:bg-white transition-all rounded-sm shadow-xl">
                      <?php echo e($exp->button_text); ?>
      ...
      <div class="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative group">
          ...
          <div class="swiper handmade-col-swiper overflow-hidden">
            <div class="swiper-wrapper">
              <?php $__currentLoopData = $handmadeProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <div class="swiper-slide p-1">
                <div class="group relative rounded-xl overflow-hidden border" style="background:#2a0038;border-color:rgba(184,137,77,0.4);">
                  <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="block aspect-[3/4] overflow-hidden" style="background:#1a0026;">
                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                  </a>
                  <button
                    type="button"
                    class="wishlist-btn absolute top-3 right-3 z-20 h-9 w-9 rounded-full border bg-white/90 text-gray-700 shadow-sm backdrop-blur transition hover:scale-105 hover:bg-white <?php echo e($product->is_wishlisted ? 'text-red-500' : ''); ?>"
                    data-product-id="<?php echo e($product->id); ?>"
                    aria-label="Add to wishlist"
                  ...
                  <div class="p-3 sm:p-4 text-center">
                    <h3 class="font-heading text-sm sm:text-base truncate" style="color:#f7d7aa;"><?php echo e($product->name); ?></h3>
                    <p class="mt-1 text-sm font-bold" style="color:#f0c58f;">₹<?php echo e(number_format($product->price, 0)); ?></p>
                    <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="mt-3 inline-flex items-center justify-center w-full rounded-md px-3 py-2 text-xs font-bold uppercase tracking-wider transition-colors" style="background:#f0c58f;color:#2a0e34;">Shop Now</a>
                  </div>
                </div>
              </div>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="mt-8 text-center">
          <a href="<?php echo e(route('front.products.index', ['category' => 'handmade-earrings', 'force_theme' => 'jewellery'])); ?>" class="inline-flex items-center justify-center px-10 py-3 rounded-md border font-heading text-sm sm:text-base uppercase tracking-wider transition-colors" style="border-color:#f0c58f;color:#f7d7aa;">
  ...
  <div id="jewellery-explore-more">
    <?php echo $__env->make('partials.front.explore-grid', ['theme' => 'jewellery'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  <div id="jewellery-read-blog">
    <?php echo $__env->make('partials.front.blog-section', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  <div id="jewellery-reviews">
    <?php echo $__env->make('partials.front.reviews', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  <div id="jewellery-about-story">
    <?php echo $__env->make('partials.front.about_story', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  ...
  window.__AVNEE_CUSTOM_SWIPERS__ = true;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (lookbookStageJw && lookbookPrevJw && lookbookNextJw) {
          const lookbookItemsJw = <?php echo json_encode($jewelleryLookbookVideos, 15, 512) ?>;
...
<?php echo $__env->make('layouts.front.jewellery', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/jewellery.blade.php ENDPATH**/ ?>