...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', $settings['site_name'] ?? 'AVNEE Collections'); ?> - <?php echo e($settings['default_meta_title'] ?? 'Exquisite Handcrafted Indian Jewellery'); ?></title>
  <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $settings['default_meta_description'] ?? 'AVNEE Collections – Premium handcrafted Indian jewellery. Kundan, Meenakari, Jhumkas & Bridal sets. Free shipping above ₹1499.'); ?>" />

  <?php echo $settings['custom_pixels'] ?? ''; ?>
  ...
  <style>
    :root {
      --studio-light-pink: #2B003A;
      --studio-dark-pink: #d4af37;
    }

    .bg-top-bar {
      background-color: #5a1b6e !important;
    }

    .bg-top-bar-dark {
      background-color: #2b003a !important;
    }
    ...
    body {
      ...
      background: radial-gradient(circle at 20% 30%, rgba(255,255,255,0.05), transparent 40%), radial-gradient(circle at 80% 70%, rgba(255,215,0,0.08), transparent 40%), linear-gradient(135deg, #2B0A3D, #3A0F4F, #5A1E7A);
    }
    ...
    .search-input:focus {
      ...
      border-color: var(--studio-dark-pink);
    }
    ...
    /* Add borders and shadows to all main sections in jewellery */
    .section-card,
    .jewellery-block {
    ...
    /* Jewellery homepage: gold borders for key sections */
    .jewellery-home-sequence #hero-slider,
    .jewellery-home-sequence #home-featured-collections,
    .jewellery-home-sequence #trending-now-static,
    .jewellery-home-sequence #shop-by-price-static,
    .jewellery-home-sequence #shop-by-style-static {
      border: 1px solid #d4af37;
      box-shadow: 0 8px 22px rgba(212, 175, 55, 0.16);
      border-radius: 0;
    }

    /* Golden separator lines for jewellery homepage sections */
    .golden-separator {
      height: 2px;
    ...
    .golden-separator::before {
      ...
      animation: golden-flow 2s linear infinite;
    }
    ...
    /* Jewellery price badges: black + gold look (expected) */
    #shop-by-price-static .price-badge-wrap .scallop-fill {
      fill: #170816;
    }
    #shop-by-price-static .price-badge-wrap .scallop-stroke {
      stroke: #d4af37;
    }
    #shop-by-price-static .price-badge-label {
      color: #d4af37;
      opacity: 0.9;
    }
    #shop-by-price-static .price-badge-value {
      color: #f4d06f;
    }
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-9 text-xs sm:text-sm">
        ...
        <div class="hidden sm:flex items-center gap-3">
          <a href="<?php echo e(route('front.home')); ?>" id="brand-studio"
            class="text-[#f3d9ff] font-medium hover-underline text-[10px] sm:text-xs transition-colors duration-200">
            STUDIO
          </a>
          <a href="<?php echo e(route('front.jewellery')); ?>" id="brand-jewellery"
            class="bg-soft-gold text-jw-primary text-[10px] sm:text-xs font-semibold tracking-wider px-3 py-1 rounded-sm">
            JEWELLERY
          </a>
        </div>
        ...
        <div class="hidden md:flex items-center gap-5 text-xs">
          <a href="<?php echo e(route('front.blog.index')); ?>" id="link-blog" class="hover-underline font-medium text-top-bar-text transition-colors duration-200">BLOG</a>
          <a href="<?php echo e(route('front.track_order', ['theme' => 'jewellery'])); ?>" id="link-track-order" class="hover-underline font-medium text-top-bar-text transition-colors duration-200 uppercase tracking-widest">Track Order</a>
        </div>
  ...
  <div class="sm:hidden bg-top-bar border-y border-[#f3d9ff]/25">
    <div class="max-w-[1440px] mx-auto px-4 py-2 flex items-center justify-start gap-2">
      ...
      <a href="<?php echo e(route('front.jewellery')); ?>"
        class="bg-soft-gold text-jw-primary text-[10px] font-semibold tracking-[0.16em] uppercase px-3 py-1 rounded-sm">
        Jewellery
      </a>
    </div>
  </div>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-[auto_1fr_auto] lg:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center h-16 sm:h-24 gap-2 sm:gap-4">
        ...
        <div class="flex justify-center min-w-0 px-1">
          <a href="<?php echo e(route('front.jewellery')); ?>" id="logo" class="flex flex-col items-center shrink-0 group max-[390px]:scale-90">
        ...
        <!-- Right: Action Icons -->
        <div class="header-action-icons flex items-center justify-end flex-nowrap gap-1.5 sm:gap-3 lg:gap-4 font-semibold text-[#fdf2f8] min-w-0">
          ...
          <div class="relative" id="account-menu-root">
            ...
            <div id="account-menu-panel" class="hidden absolute right-0 top-full mt-3 w-[290px] bg-[#350047] border border-[#4f006a] shadow-2xl rounded-md z-50 overflow-hidden">
              <div class="px-4 py-3 border-b border-[#4f006a] bg-[#2b003a]">
                ...
                <p class="text-xs text-[#d8b6d8] truncate"><?php echo e(auth()->user()->email); ?></p>
              </div>

              <div class="py-1 text-sm">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center justify-between px-4 py-3 text-[#f3d9ff] hover:bg-[#230030]">
                  <span>Account Details</span><span>›</span>
                </a>
                <a href="<?php echo e(route('front.orders.index', ['source' => 'online'])); ?>" class="flex items-center justify-between px-4 py-3 text-[#f3d9ff] hover:bg-[#230030]">
                  <span>My Online Order</span><span>›</span>
                </a>
                <a href="<?php echo e(route('front.orders.index', ['source' => 'offline'])); ?>" class="flex items-center justify-between px-4 py-3 text-[#f3d9ff] hover:bg-[#230030]">
                  <span>My Offline Order</span><span>›</span>
                </a>
                <a href="<?php echo e(route('profile.edit')); ?>" class="flex items-center justify-between px-4 py-3 text-[#f3d9ff] hover:bg-[#230030]">
                  <span>Addresses</span><span>›</span>
                </a>
                <a href="<?php echo e(route('front.wishlist.index')); ?>" class="flex items-center justify-between px-4 py-3 text-[#f3d9ff] hover:bg-[#230030]">
                  <span>Wishlist</span><span>›</span>
                </a>
              </div>

              <form action="<?php echo e(route('logout')); ?>" method="POST" class="border-t border-[#4f006a] bg-[#2b003a]">
                <?php echo csrf_field(); ?>
                <button type="submit" class="w-full text-left px-4 py-3 text-sm text-[#f3d9ff] hover:bg-[#230030]">Sign Out</button>
              </form>
            </div>
            <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" id="icon-account" class="hover:text-[#d4af37] p-1 sm:p-2 transition-all" aria-label="My Account" title="My Account">
              <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                  d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
              </svg>
          ...
          <!-- Wishlist -->
          <a href="<?php echo e(route('front.wishlist.index')); ?>" id="icon-wishlist" class="hover:text-[#d4af37] p-1 sm:p-2 transition-all" aria-label="Wishlist" title="Wishlist">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Cart with Badge -->
          <a href="<?php echo e(route('front.cart.index')); ?>" id="icon-cart" class="hover:text-[#d4af37] p-1 sm:p-2 relative transition-all" aria-label="Cart" title="Shopping Cart">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
        ...
        <div class="flex-1 overflow-y-auto py-6 px-6">
            <div class="space-y-6">
                <div class="space-y-4">
                    ...
                    <a href="<?php echo e(route('front.home')); ?>" class="block text-sm font-medium text-gray-300 hover:text-[#d4af37] transition-colors">Studio Store</a>
                    <a href="<?php echo e(route('front.jewellery')); ?>" class="block text-sm font-medium text-gray-300 hover:text-[#d4af37] transition-colors">Jewellery Home</a>
                </div>
                ...
                <div class="pt-6 border-t border-[#4f006a] space-y-4">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('dashboard')); ?>" class="block text-sm font-medium text-gray-300">My Profile</a>
                        <a href="<?php echo e(route('front.orders.index')); ?>" class="block text-sm font-medium text-gray-300">My Orders</a>
                        <form action="<?php echo e(route('logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="text-sm font-bold text-red-400 uppercase tracking-widest mt-2">Sign Out</button>
                        </form>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block text-sm font-medium text-gray-300">Login</a>
                        <a href="<?php echo e(route('register')); ?>" class="block text-sm font-medium text-gray-300">Register</a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('front.blog.index')); ?>" class="block text-sm font-medium text-gray-300">Fashion Blog</a>
                    <a href="<?php echo e(route('front.track_order')); ?>" class="block text-sm font-medium text-gray-300">Track Order</a>
                </div>
            </div>
        </div>

        <div class="p-6 bg-[#0a0711] border-t border-[#4f006a] italic text-[11px] text-gray-500 text-center">
            &copy; <?php echo e(date('Y')); ?> AVNEE Collections. Luxury Jewellery.
        </div>
    </div>
  </div>
  ...
  <nav class="lg:hidden bg-[#2B003A] border-y border-[#f8c8dc]/40">
    <div class="px-3">
      <ul class="flex items-center justify-start gap-2 py-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
        <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'jewellery-new-arrivals'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="<?php echo e(route('front.jewellery')); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">JEWELLERY</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'bags'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">BAGS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'footwear'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">FOOTWEAR</a></li>
        <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'gifting'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">GIFTING</a></li>
        <li><a href="<?php echo e(route('front.sale.jewellery')); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-[#f8c8dc] border border-[#f8c8dc]/40 rounded-sm">SALE</a></li>
      </ul>
    </div>
  </nav>
  ...
  <nav id="main-nav" class="bg-[#4B0082] hidden lg:block" style="border-top: 1px solid rgba(164, 125, 171, 0.35); border-bottom: 2px solid #A47DAB;">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
      <ul class="flex items-center justify-center gap-4 xl:gap-6 h-12">
        <li><a href="<?php echo e(route('front.sale.jewellery')); ?>" class="nav-item-link rounded-sm">SALE</a></li>
        <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'jewellery-new-arrivals'])); ?>" class="nav-item-link rounded-sm">NEW ARRIVALS</a></li>
        <li class="group relative">
          <a href="<?php echo e(route('front.products.index', ['category' => 'jewellery-gallery'])); ?>" class="nav-item-link rounded-sm">JEWELLERY</a>
          <div class="absolute top-full left-1/2 -translate-x-1/2 mega-menu-panel shadow-2xl hidden group-hover:block z-[120] border border-[#f8c8dc]/30">
            <div class="p-4">
              <div class="grid grid-cols-5 gap-3">
                <a href="<?php echo e(route('front.products.index', ['category' => 'earrings'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-MAN-C54/AVN-JW-HAN-MAN-C54-01.png')); ?>" alt="Ear Rings">
                  <span>EAR RINGS</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'bracelets'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-STR-C53/AVN-JW-HAN-STR-C53-01.png')); ?>" alt="Bracelets">
                  <span>BRACELETS</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'chokers-necklaces'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Viraasat Floral Necklace Set/AVN-JW-NEC-RRD-C57/AVN-JW-NEC-RRD-C57-02.png')); ?>" alt="Chokers & Necklaces">
                  <span>CHOKERS & NECKLACES</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'rings'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-PIN-C47/AVN-JW-HAN-PIN-C47-01.png')); ?>" alt="Rings">
                  <span>RINGS</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'toe-rings'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-FLA-C45/AVN-JW-HAN-FLA-C45-01.png')); ?>" alt="Toe Rings">
                  <span>TOE RINGS</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'bangles'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-SHL-C52/AVN-JW-HAN-SHL-C52-01.png')); ?>" alt="Bangles">
                  <span>BANGLES</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'maang-tikka'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-BUT-C51/AVN-JW-HAN-BUT-C51-01.png')); ?>" alt="Maang Tikka">
                  <span>MAANG TIKKA</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'nosepins'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-MAN-C54/AVN-JW-HAN-MAN-C54-01.png')); ?>" alt="Nosepins">
                  <span>NOSEPINS</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'hair-accessories'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-STR-C53/AVN-JW-HAN-STR-C53-01.png')); ?>" alt="Hair Accessories">
                  <span>HAIR ACCESSORIES</span>
                </a>
                <a href="<?php echo e(route('front.products.index', ['category' => 'chains'])); ?>" class="mega-card">
                  <img src="<?php echo e(asset('images/jewellery/Avnee_s Handmade  Statement Earrings/AVN-JW-HAN-PIN-C47/AVN-JW-HAN-PIN-C47-01.png')); ?>" alt="Chains">
                  <span>CHAIN</span>
                </a>
              </div>
            </div>
        ...
        <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'organizers'])); ?>" class="nav-item-link rounded-sm">ORGANIZERS</a></li>
        <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'gifting'])); ?>" class="nav-item-link rounded-sm">GIFTING</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'hair-accessories'])); ?>" class="nav-item-link rounded-sm">HAIR ACCESSORIES</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'watches'])); ?>" class="nav-item-link rounded-sm">WATCHES</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'trinkets'])); ?>" class="nav-item-link rounded-sm">TRINKETS</a></li>
      </ul>
    </div>
  </nav>
  ...
  <footer class="bg-[#230030] text-white pt-0 pb-6" style="border-top: 3px solid #d4af37;">
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12 pt-16">
        ...
        <?php
          $footerAboutHeading = $settings['footer_about_heading'] ?? 'About our brand';
          $footerAboutParagraph1 = $settings['footer_about_paragraph_1'] ?? 'AVNEE Collections is a thoughtfully curated space for kidswear and everyday jewelry - created with love, comfort, and style in mind.';
          $footerAboutParagraph2 = $settings['footer_about_paragraph_2'] ?? 'Inspired by little moments and the joy of dressing up, we bring together pieces that celebrate both childhood and the woman behind it - simple, elegant, and made to feel special every day.';
          $footerShopHeading = $settings['footer_shop_heading'] ?? 'Shop';
          $footerShopKidsLabel = $settings['footer_shop_kids_label'] ?? 'Kids Collection';
          $footerShopJewelleryLabel = $settings['footer_shop_jewellery_label'] ?? 'Jewellery';
          $footerShopSareesLabel = $settings['footer_shop_sarees_label'] ?? 'Sarees';
          $footerShopTrinketsLabel = $settings['footer_shop_trinkets_label'] ?? 'Funky Trinkets';
          $footerShopHairLabel = $settings['footer_shop_hair_label'] ?? 'Hair Accessories';
          $footerShopAllLabel = $settings['footer_shop_all_label'] ?? 'All Collections';
        ?>

        <!-- Column 1: About Brand -->
        <div class="pr-0 lg:pr-6">
          <h4 class="footer-heading text-[#f3d9ff] font-semibold tracking-[0.12em] uppercase text-[15px]"><?php echo e($footerAboutHeading); ?></h4>
          <p class="text-[#e9d5ff] text-[15px] leading-7 mb-4">
            <?php echo e($footerAboutParagraph1); ?>

          </p>
          <p class="text-[#e9d5ff] text-[15px] leading-7 mb-6">
            <?php echo e($footerAboutParagraph2); ?>
          ...
          <div class="flex items-center gap-3">
            ...
            <a href="<?php echo e($settings['facebook_url']); ?>" target="_blank" title="Facebook"
            ...
            <a href="<?php echo e($settings['instagram_url']); ?>" target="_blank" title="Instagram"
              class="w-8 h-8 rounded-full border border-[#f3d9ff]/30 flex items-center justify-center text-[#f3d9ff] hover:bg-[#f3d9ff] hover:border-[#f3d9ff] hover:text-[#1a0023] transition-colors duration-300">
            ...
            <a href="<?php echo e($settings['twitter_url']); ?>" target="_blank" title="Twitter / X"
              class="w-8 h-8 rounded-full border border-[#f3d9ff]/30 flex items-center justify-center text-[#f3d9ff] hover:bg-[#f3d9ff] hover:border-[#f3d9ff] hover:text-[#1a0023] transition-colors duration-300">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo e($settings['youtube_url']); ?>" target="_blank" title="YouTube"
              class="w-8 h-8 rounded-full border border-[#f3d9ff]/30 flex items-center justify-center text-[#f3d9ff] hover:bg-[#f3d9ff] hover:border-[#f3d9ff] hover:text-[#1a0023] transition-colors duration-300">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $settings['whatsapp_number'])); ?>" target="_blank" title="WhatsApp"
              class="w-8 h-8 rounded-full border border-[#f3d9ff]/30 flex items-center justify-center text-[#f3d9ff] hover:bg-[#f3d9ff] hover:border-[#f3d9ff] hover:text-[#1a0023] transition-colors duration-300">
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Column 2: Shop -->
        <div>
          <h4 class="footer-heading text-[#f3d9ff] font-semibold tracking-[0.12em] uppercase text-[15px]"><?php echo e($footerShopHeading); ?></h4>
          <ul class="space-y-3.5">
            <li><a href="<?php echo e(route('front.sale.studio.kids')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Kids Collection</a></li>
            <li><a href="<?php echo e(route('front.sale.jewellery')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Jewellery</a></li>
            <li><a href="<?php echo e(route('front.sale.studio.sarees')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Sarees</a></li>
            <li><a href="<?php echo e(route('front.sale.jewellery.accessories')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Hair Accessories</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'organizers'])); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Organizers</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'gifting'])); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Gifting</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'watches'])); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Watches</a></li>
            <li><a href="<?php echo e(route('front.sale.studio.trinkets')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Trinkets</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3.5">
            <li><a href="<?php echo e(route('front.page', 'terms-of-service')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Terms of Service</a></li>
            <li><a href="<?php echo e(route('front.page', 'privacy-policy')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Privacy Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'return-exchange-policy')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Returns Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'shipping-policy')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Shipping Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'faqs')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">FAQ's</a></li>
            <li><a href="<?php echo e(route('front.contact')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Contact Us</a></li>
            <li><a href="<?php echo e(route('front.careers')); ?>" class="text-[#e9d5ff] text-[15px] hover:text-[#f3d9ff] transition-colors">Careers</a></li>
          </ul>
        </div>
      ...
      <div class="pt-8 border-t border-[#2a2218] flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div
          ...
          <span>&copy; <?php echo e(date('Y')); ?> AVNEE Collections - All Rights Reserved.</span>
        </div>
  ...
  <div id="mobile-menu-panel"
    ...
    <div class="p-5">
      ...
      <nav class="space-y-1">
        ...
        <a href="<?php echo e(route('front.products.index', ['category' => $category->slug])); ?>"
        ...
        <div class="pt-4 space-y-3">
          ...
          <a href="<?php echo e(route('front.blog.index')); ?>"
        ...
        if (searchInput && searchResults) {
            searchInput.addEventListener('input', function() {
                ...
                debounceTimer = setTimeout(() => {
                    fetch(`<?php echo e(route('front.products.search')); ?>?q=${encodeURIComponent(query)}`)
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            ...
            fetch("<?php echo e(route('front.wishlist.toggle')); ?>", {
                method: 'POST',
                headers: {
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        form.addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("front.newsletter.subscribe")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/layouts/front/jewellery.blade.php ENDPATH**/ ?>