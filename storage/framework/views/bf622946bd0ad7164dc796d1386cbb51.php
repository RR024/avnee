<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-[1440px] mx-auto">
      ...
      <div class="swiper-wrapper">
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.collection', ['collection' => 'summer-classics'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/summer-classics.png')); ?>" alt="Summer Classics" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.collection', ['collection' => 'birthday-glam'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/birthday.png')); ?>" alt="Birthday Glam" class="w-full h-full object-cover" />
          </a>
        </div>
        <div class="swiper-slide">
          <a href="<?php echo e(route('front.products.collection', ['collection' => 'ugadi-sale'])); ?>" class="block w-full h-full">
            <img src="<?php echo e(asset('images/hero-slider/ugadi-sale.png')); ?>" alt="Ugadi Sale" class="w-full h-full object-cover" />
          </a>
        </div>
      </div>
  ...
  <section id="just-in" class="relative w-full px-4 sm:px-6 lg:px-8 py-8 sm:py-10 bg-[#FCEFF5]">
    <div class="max-w-[1320px] mx-auto">
      ...
      <div class="grid grid-cols-2 gap-4 sm:gap-6">
        <a href="<?php echo e(route('front.products.collection', ['collection' => 'sale'])); ?>" class="block w-full border border-[#2B003A]/25 bg-white shadow-sm overflow-hidden">
          <img src="<?php echo e(asset('images/just-in/Picture1.png')); ?>" alt="Just in new launches 1" class="w-full aspect-[16/10] object-cover" />
        </a>
        <a href="<?php echo e(route('front.products.collection', ['collection' => 'new-arrivals'])); ?>" class="block w-full border border-[#2B003A]/25 bg-white shadow-sm overflow-hidden">
          <img src="<?php echo e(asset('images/just-in/Picture2.png')); ?>" alt="Just in new launches 2" class="w-full aspect-[16/10] object-cover" />
        </a>
      </div>
    </div>
  </section>
    ...
    <div class="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="relative group">
        ...
        <div class="swiper best-buy-static-swiper overflow-hidden rounded-xl">
          <div class="swiper-wrapper">
            <?php $__currentLoopData = $bestBuyCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $cardSlug = Illuminate\Support\Str::slug($card['title']); ?>
              <div class="swiper-slide p-1">
                <article onclick="navigateToBestBuys('<?php echo e($cardSlug); ?>')" class="bg-white rounded-2xl overflow-hidden border border-gray-200 shadow-sm h-[560px] cursor-pointer transition-transform duration-200 hover:-translate-y-1 flex flex-col">
                  <div class="relative aspect-[3/4] overflow-hidden bg-gray-100 flex-shrink-0">
                    <img src="<?php echo e($card['image']); ?>" alt="<?php echo e($card['title']); ?>" loading="lazy" class="w-full h-full object-cover" />
                    <?php if(isset($bestBuyProductIds[$cardSlug])): ?>
                      <button
                        type="button"
                        ...
                        data-product-id="<?php echo e($bestBuyProductIds[$cardSlug]); ?>"
                  ...
                  <div class="p-3 sm:p-4 flex-1 flex flex-col">
                    <h3 class="text-lg sm:text-xl font-bold text-[#141414] leading-tight line-clamp-2 mb-1"><?php echo e($card['title']); ?></h3>
                    <p class="text-sm sm:text-base text-[#3b3b3b] leading-snug line-clamp-2 mb-2 flex-1"><?php echo e($card['description']); ?></p>
                    <p class="mt-auto pt-1 text-lg sm:text-xl font-black leading-none text-[#C75B6E]">₹<?php echo e(number_format($card['price'], 0)); ?></p>
                  </div>
                </article>
              </div>
  ...
  <script>
    function navigateToBestBuys(slug) {
      if (!slug) return;
      window.location.href = '<?php echo e(route('front.best-buys')); ?>/' + encodeURIComponent(slug);
    }
  </script>
    ...
    <div class="relative max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8" id="lookbook-stage-wrap">
      ...
      <div id="lookbook-stage" class="lookbook-stage pb-8">
        <?php $__currentLoopData = [-2, -1, 0, 1, 2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="look-slot" data-slot="<?php echo e($slot); ?>">
            <div class="look-slot-inner relative overflow-hidden rounded-2xl border border-gray-200 shadow-sm bg-white">
              <video class="lookbook-video absolute inset-0 w-full h-full object-cover" muted loop playsinline preload="metadata" poster="" crossorigin="anonymous"></video>
 ...
 <section id="home-top-collections" class="pt-10 pb-4 sm:pt-12 sm:pb-6 bg-[#FCEFF5]">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5">
        <?php $__currentLoopData = $topCollections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <article class="group relative overflow-hidden rounded-2xl bg-[#f3e3ea] shadow-sm">
            <a href="<?php echo e($card['link']); ?>" class="block relative aspect-[3/4]">
              <img src="<?php echo e($card['image']); ?>" alt="<?php echo e($card['title']); ?>" loading="lazy" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" />
              ...
              <div class="absolute left-3 right-3 bottom-3 bg-[#f8f4f1]/90 backdrop-blur-sm rounded-xl px-3 py-3 text-center">
                <h3 class="font-heading text-xl sm:text-2xl leading-tight text-[#3a2c2c] mb-2"><?php echo e($card['title']); ?></h3>
                <span class="inline-flex items-center justify-center px-4 py-2 text-xs sm:text-sm font-semibold text-white bg-[#171717] rounded-md transition-colors duration-300 group-hover:bg-[#2d2d2d]"><?php echo e($card['button']); ?></span>
              </div>
            </a>
          </article>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="flex flex-wrap justify-center gap-6 sm:gap-10 lg:gap-16">
        ...
        <a href="<?php echo e($band['url']); ?>" class="price-badge-wrap group relative flex shrink-0 items-center justify-center">
          ...
          <div class="relative z-10 flex min-w-0 w-full flex-col items-center justify-center px-1 text-center">
            ...
            <span class="font-heading text-2xl sm:text-3xl lg:text-4xl font-bold tabular-nums text-pastel-pink tracking-wider whitespace-nowrap leading-tight">₹<?php echo e($band['price']); ?></span>
          </div>
        </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    ...
    <div class="w-full px-3 sm:px-4 lg:px-8 xl:px-10">
      ...
      <?php
        $styleCards = [
          ...
          ['label' => '2 - 4 Yrs', 'slug' => '2-4-years', 'image' => 'images/shop-by-style/2-4-years.png'],
          ['label' => '4 - 6 Yrs', 'slug' => '4-6-years', 'image' => 'images/shop-by-style/4-6-years.png'],
          ['label' => '6 - 14 Yrs', 'slug' => '6-14-years', 'image' => 'images/shop-by-style/6-14-years.png'],
      ...
      <div class="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-7 gap-x-5 sm:gap-x-7 lg:gap-x-10 xl:gap-x-12 gap-y-5 sm:gap-y-6">
        <?php $__currentLoopData = $styleCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $styleCard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          ?>
          <a href="<?php echo e(route('front.products.index', ['category' => $styleCard['slug']])); ?>" class="group block text-center">
            <div class="aspect-[4/5] bg-white overflow-hidden shadow-sm border border-[#2B003A]/10 hover:shadow-lg transition-all duration-300">
              <img src="<?php echo e(asset($styleCard['image']) . '?v=' . $styleImageVersion); ?>" alt="<?php echo e($styleCard['label']); ?>" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
            <p class="mt-3 text-sm sm:text-base text-[#C75B6E] font-semibold tracking-[0.08em] uppercase"><?php echo e($styleCard['label']); ?></p>
          </a>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
    </div>
  ...
  <?php if(false && $activeFlashSale && $activeFlashSale->products->isNotEmpty()): ?>
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
        <div class="flex items-center gap-4">
          ...
          <div>
            <h2 class="studio-section-heading studio-section-heading--left studio-section-heading--flash"><?php echo e($activeFlashSale->title); ?></h2>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide px-1">
              <div class="group bg-[#F8C8DC] rounded-sm overflow-hidden border border-transparent hover:border-mulberry/10 transition-all shadow-sm">
                <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="relative block bg-gray-100 aspect-[3/4]">
                ...
                <button
                  type="button"
                  class="wishlist-btn absolute top-3 left-3 z-20 h-9 w-9 rounded-full border border-white/70 bg-white/90 text-gray-700 shadow-sm backdrop-blur transition hover:scale-105 hover:bg-white <?php echo e($product->is_wishlisted ? 'text-red-500' : ''); ?>"
                ...
                <div class="p-3">
                  <h3 class="text-xs font-medium text-gray-800 line-clamp-1 mb-2"><?php echo e($product->name); ?></h3>
                  <div class="flex items-center gap-2">
                    <span class="text-sm font-bold text-mulberry">₹<?php echo e(number_format($product->price, 2)); ?></span>
                    <?php if($product->compare_price > $product->price): ?>
                    <span class="text-xs text-gray-400 line-through">₹<?php echo e(number_format($product->compare_price, 2)); ?></span>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
  ...
  <?php if(false && isset($combos) && $combos->count() > 0): ?>
  <section id="combo-deals" class="py-12 sm:py-20 bg-[#FCEFF5] border-b border-pastel-pink/20">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col md:flex-row justify-between items-center mb-12 gap-6 text-center md:text-left">
        ...
        <a href="<?php echo e(route('front.products.index')); ?>" class="px-8 py-3 bg-mulberry text-white text-xs font-bold uppercase tracking-[0.3em] hover:bg-mulberry-dark transition-all">Shop All Sets</a>
      </div>
      <div class="relative group">
            ...
            <div class="swiper-slide h-auto pb-4">
              <div class="group relative flex flex-col bg-[#F8C8DC] rounded-sm overflow-hidden hover:shadow-2xl transition-all duration-500 h-full border border-pastel-pink/20 mx-1">
                <div class="relative aspect-[16/10] overflow-hidden">
                  <?php if($combo->image): ?>
                    <img src="<?php echo e(asset('storage/' . $combo->image)); ?>" alt="<?php echo e($combo->title); ?>" class="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
                  <?php else: ?>
                    <img src="<?php echo e(asset('storage/' . $combo->products->first()->image)); ?>" alt="<?php echo e($combo->title); ?>" class="w-full h-full object-cover grayscale brightness-75 transition-transform duration-1000 group-hover:scale-110" />
                  <?php endif; ?>
                  ...
                  <div class="absolute top-0 right-0 bg-mulberry text-pastel-pink px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] shadow-lg">
                    Save ₹<?php echo e(number_format($combo->original_price - $combo->price, 0)); ?>
                ...
                <div class="p-8 flex-1 flex flex-col">
                  <div class="mb-6 flex-1">
                    <h3 class="font-heading text-2xl mb-4 group-hover:text-mulberry transition-colors uppercase tracking-wider leading-tight text-gray-900"><?php echo e($combo->title); ?></h3>
                    <div class="flex items-center gap-3">
                      ...
                      <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest"><?php echo e($combo->products->count()); ?> Item Set</span>
                    </div>
                  </div>
                  <div class="flex items-center justify-between pt-6 border-t border-gray-100">
                    <div class="flex flex-col">
                      <span class="text-2xl font-bold text-gray-900">₹<?php echo e(number_format($combo->price, 2)); ?></span>
                      <?php if($combo->original_price): ?>
                      <span class="text-xs text-gray-400 line-through tracking-wider">₹<?php echo e(number_format($combo->original_price, 2)); ?></span>
                      <?php endif; ?>
                    </div>
  ...
  <?php if(isset($justInExperiences) && $justInExperiences->isNotEmpty()): ?>
  <section id="just-in" class="py-10 sm:py-14 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-5">
      ...
      <a href="<?php echo e($exp->button_link); ?>" class="group relative block overflow-hidden aspect-[4/5] bg-gray-100 rounded-sm border border-mulberry/10">
  ...
  <?php
    $newInJewelleryProducts = \App\Models\Product::query()
      ...
      ->get();
  ?>
  <?php if($newInJewelleryProducts->isNotEmpty()): ?>
  <section id="popular-pieces" class="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto overflow-hidden">
    ...
    <div class="relative group">
      ...
      <div class="swiper new-in-jewellery-swiper overflow-visible">
        <div class="swiper-wrapper">
          <?php $__currentLoopData = $newInJewelleryProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="swiper-slide">
            <div class="group relative">
              <a href="<?php echo e(route('front.product.detail', $product->slug)); ?>" class="block aspect-[3/4] bg-mulberry overflow-hidden">
              ...
              <div class="pt-4 px-1 text-center">
                <h3 class="text-[11px] font-bold text-gray-800 uppercase tracking-wider mb-1 truncate"><?php echo e($product->name); ?></h3>
                <p class="text-xs font-bold text-mulberry">₹<?php echo e(number_format($product->price, 0)); ?></p>
              </div>
            </div>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="relative group">
        ...
        <div class="swiper studio-edits-swiper overflow-hidden">
          <div class="swiper-wrapper">
              ...
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[1.22fr_0.98fr] gap-3 sm:gap-4 lg:gap-6">
                <div class="grid grid-cols-[1.05fr_0.95fr] gap-3 sm:gap-4">
                  <div class="row-span-2">
                    <img src="<?php echo e(asset('images/saree-edit/1.webp')); ?>" alt="Saree Edit Look 1" class="w-full h-full object-cover object-top min-h-[360px] lg:min-h-[610px]" />
                  </div>
                  <div>
                    <img src="<?php echo e(asset('images/saree-edit/2.webp')); ?>" alt="Saree Edit Look 2" class="w-full h-full object-cover object-top min-h-[170px] lg:min-h-[246px]" />
                  </div>
                  <div class="grid grid-cols-2 gap-3 sm:gap-4 col-span-1">
                    <img src="<?php echo e(asset('images/saree-edit/3.webp')); ?>" alt="Saree Edit Look 3" class="w-full h-full object-cover object-top min-h-[185px] lg:min-h-[350px]" />
                    <img src="<?php echo e(asset('images/saree-edit/4.webp')); ?>" alt="Saree Edit Look 4" class="w-full h-full object-cover object-top min-h-[185px] lg:min-h-[350px]" />
                  </div>
                </div>
                <div class="flex items-center justify-center text-center px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    ...
                    <a href="<?php echo e(route('front.sale')); ?>" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors mb-8">PRE-DRAPE NOW</a>
            ...
            <div class="swiper-slide">
              <h2 class="studio-section-heading mb-9 sm:mb-12" style = "color: #C75B6E;"><?php echo e($funTrinketsExp->title ?? 'The Fun Trinkets Edit'); ?></h2>
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[1.22fr_0.98fr] gap-3 sm:gap-4 lg:gap-6">
                <div class="grid grid-cols-[1.05fr_0.95fr] gap-3 sm:gap-4">
                  <div class="row-span-2">
                    <img src="<?php echo e(!empty($funTrinketsExp?->image_1) ? asset('storage/' . $funTrinketsExp->image_1) : asset('images/trinkets/WhatsApp Image 2026-04-06 at 3.31.28 AM (1).jpeg')); ?>" alt="<?php echo e($funTrinketsExp->image_1_label ?? ($funTrinketsExp->title ?? 'Fun Trinkets')); ?>" class="w-full h-full object-cover object-top min-h-[360px] lg:min-h-[610px]" />
                    <?php if(!empty($funTrinketsExp?->image_1_label)): ?>
                      <p class="mt-3 text-center text-2xl text-[#5f1f1f] font-medium"><?php echo e($funTrinketsExp->image_1_label); ?></p>
                    <?php endif; ?>
                  </div>
                  <div>
                    <img src="<?php echo e(!empty($funTrinketsExp?->image_2) ? asset('storage/' . $funTrinketsExp->image_2) : asset('images/trinkets/WhatsApp Image 2026-04-06 at 3.31.27 AM (2).jpeg')); ?>" alt="<?php echo e($funTrinketsExp->image_2_label ?? ($funTrinketsExp->title ?? 'Fun Trinkets')); ?>" class="w-full h-full object-cover object-top min-h-[170px] lg:min-h-[246px]" />
                  </div>
                  <div class="col-span-1">
                    <img src="<?php echo e(!empty($funTrinketsExp?->image_3) ? asset('storage/' . $funTrinketsExp->image_3) : asset('images/trinkets/WhatsApp Image 2026-04-06 at 3.31.29 AM.jpeg')); ?>" alt="<?php echo e($funTrinketsExp->image_3_label ?? ($funTrinketsExp->title ?? 'Fun Trinkets')); ?>" class="w-full h-full object-cover object-top min-h-[185px] lg:min-h-[350px]" />
                    <?php if(!empty($funTrinketsExp?->image_3_label)): ?>
                      <p class="mt-3 text-center text-2xl text-[#5f1f1f] font-medium"><?php echo e($funTrinketsExp->image_3_label); ?></p>
                    <?php endif; ?>
                  </div>
                </div>
                <div class="flex items-center justify-center text-left px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    <h3 class="font-heading text-5xl sm:text-7xl text-[#5f1f1f] leading-[0.92] mb-6"><?php echo e($funTrinketsExp->content_title ?? 'Discover Cute Trinkets!'); ?></h3>
                    <p class="text-gray-900 text-base sm:text-xl leading-snug mb-8"><?php echo e($funTrinketsExp->content_description ?? 'Explore an adorable selection of keychains and collectibles to brighten your day.'); ?></p>
                    <a href="<?php echo e(route('front.sale')); ?>" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors"><?php echo e($funTrinketsExp->button_text ?? 'SHOP NOW'); ?></a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="swiper-slide">
              <h2 class="studio-section-heading mb-9 sm:mb-12" style = "color: #C75B6E;"><?php echo e($hairAccessoriesExp->title ?? 'The Hair Accessories Edit'); ?></h2>
              <div class="bg-[#efe8e8] p-4 sm:p-6 lg:p-7 grid grid-cols-1 lg:grid-cols-[0.95fr_1.05fr] gap-3 sm:gap-4 lg:gap-6">
                <div class="flex items-center justify-center text-left px-2 sm:px-6 lg:px-10 py-6 sm:py-10">
                  <div class="max-w-[420px]">
                    <h3 class="font-heading text-5xl sm:text-7xl text-[#5f1f1f] leading-[0.92] mb-6"><?php echo e($hairAccessoriesExp->content_title ?? 'Elevate Your Hairstyle!'); ?></h3>
                    <p class="text-gray-900 text-base sm:text-xl leading-snug mb-8"><?php echo e($hairAccessoriesExp->content_description ?? 'Explore charming hair accessories for girls and women to add a touch of beauty and fun to your look.'); ?></p>
                    <a href="<?php echo e(route('front.sale')); ?>" class="inline-block bg-black text-white text-sm sm:text-base font-bold tracking-[0.04em] px-7 py-3.5 hover:bg-[#1f1f1f] transition-colors"><?php echo e($hairAccessoriesExp->button_text ?? 'SHOP NOW'); ?></a>
                  </div>
                </div>
                <div class="grid grid-cols-2 gap-3 sm:gap-4">
                  <?php $__currentLoopData = $hairAccessoryTiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tile): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                      <img src="<?php echo e(asset($tile['image'])); ?>" alt="Hair accessory" class="w-full h-full object-cover object-top min-h-[185px] lg:min-h-[350px]" />
                    </div>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
              </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (lookbookStage && lookbookPrev && lookbookNext) {
          const lookbookItems = <?php echo json_encode($lookbookVideos, 15, 512) ?>;
...
<?php echo $__env->make('layouts.front.studio', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/welcome.blade.php ENDPATH**/ ?>