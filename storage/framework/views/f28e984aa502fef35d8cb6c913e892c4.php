...
<section id="about-story" class="py-16 sm:py-24 <?php echo e($bgColor); ?> relative overflow-hidden transition-colors duration-700">
    <!-- Subtle Background Elements -->
    <div class="absolute top-0 left-0 w-64 h-64 <?php echo e($isJewellery ? 'bg-[#350047]/20' : 'bg-[#F8C8DC]/20'); ?> rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
    <div class="absolute bottom-0 right-0 w-96 h-96 <?php echo e($isJewellery ? 'bg-[#d4af37]/5' : 'bg-mulberry/5'); ?> rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>

    <div class="max-w-[1240px] mx-auto px-4 sm:px-8 lg:px-10 relative z-10">
        <div class="text-center mb-16">
            <?php if($isJewellery): ?>
            <h2 class="font-heading text-4xl sm:text-6xl <?php echo e($headingColor); ?> font-normal tracking-[0.1em] mb-6 uppercase">
                AVNEE <span class="block text-2xl sm:text-3xl mt-2 tracking-[0.3em] font-light <?php echo e($subtitleColor); ?>">Our Story</span>
            </h2>
        ...
        <div class="space-y-10 text-center font-body">
            <div class="space-y-6">
                <h3 class="text-2xl sm:text-3xl font-heading italic <?php echo e($italicColor); ?> leading-relaxed max-w-4xl mx-auto">
                ...
                <p class="<?php echo e($textColor); ?> leading-relaxed text-lg sm:text-2xl max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-14 lg:gap-16 pt-10 border-t <?php echo e($borderColor); ?> items-start">
                <div class="text-left space-y-6">
                    <p class="<?php echo e($textColor); ?> leading-relaxed text-base sm:text-lg lg:text-xl">
                ...
                <div class="text-left space-y-6">
                    ...
                    <p class="<?php echo e($textColor); ?> leading-relaxed text-base sm:text-lg lg:text-xl font-semibold italic <?php echo e($isJewellery ? 'text-[#f3d9ff]/90' : 'text-mulberry/90'); ?>">
            ...
            <div class="pt-16 pb-8">
                <div class="<?php echo e($innerCardBg); ?> backdrop-blur-md p-8 sm:p-12 rounded-sm border <?php echo e($innerCardBorder); ?> relative overflow-hidden group">
                    <div class="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
                    </div>
                    <p class="<?php echo e($isJewellery ? 'text-[#f3d9ff]' : 'text-mulberry'); ?> text-xl sm:text-2xl font-heading leading-relaxed max-w-2xl mx-auto italic relative z-10">
...
<?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/partials/front/about_story.blade.php ENDPATH**/ ?>