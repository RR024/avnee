...
<div class="flex items-center justify-center py-6">
    ...
    <div class="absolute bottom-0 right-0 w-96 h-96 <?php echo e($isJewellery ? 'bg-[##8b4c6e]/5' : 'bg-mulberry/5'); ?> rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>
    ...
    "AVNEE Collections was born from a mother’s love for finding the perfect balance between comfort, style, and meaning in what her child wears."
                ...
                <p class="<?php echo e($textColor); ?> leading-relaxed text-lg sm:text-2xl max-w-3xl mx-auto">
