...
<head>
  ...
  <title><?php echo $__env->yieldContent('title', $settings['site_name'] ?? 'AVNEE Collections'); ?> - <?php echo e($settings['default_meta_title'] ?? 'Premium Ethnic Wear'); ?></title>
  <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $settings['default_meta_description'] ?? 'AVNEE Collections – Premium ethnic wear. Free shipping on orders above ₹1499.'); ?>" />
  ...
  <style>
    ...
    .price-badge-wrap .badge-svg circle {
      stroke: #C75B6E !important;
    }

    /* Ensure all price badges use correct stroke color */
    .badge-svg .scallop-stroke {
      stroke: #C75B6E !important;
    }
    ...
    /* Section cards and blocks with border and shadow */
    .section-card,
    .studio-block {
    ...
    .mega-card {
      ...
      box-shadow: 0 4px 12px rgba(199, 91, 110, 0.1) !important;
    }

    /* Pricing stroke border */
    .price-badge-wrap .badge-svg circle {
...
<body class="font-body antialiased bg-[#FCEFF5] text-gray-900">
      ...
      <div class="flex items-center justify-between h-9 text-xs sm:text-sm">
        ...
        <div class="hidden sm:flex items-center gap-3">
          ...
          <a href="<?php echo e(route('front.jewellery')); ?>" id="brand-jewellery"
            class="text-[#F59E0B] font-medium hover-underline transition-colors duration-200">
            JEWELLERY
          </a>
        </div>
        ...
        <div class="hidden md:flex items-center gap-5 text-xs">
          ...
          <a href="<?php echo e(route('front.track_order', ['theme' => 'studio'])); ?>" id="link-track-order" class="hover-underline font-medium text-top-bar-text transition-colors duration-200 uppercase tracking-widest">Track Order</a>
        </div>
  ...
  <div class="sm:hidden bg-mulberry border-t border-pastel-pink/20 border-b border-pastel-pink/20">
    <div class="max-w-[1440px] mx-auto px-4 py-2 flex items-center justify-between gap-2">
      ...
      <div class="flex items-center gap-3">
        <a href="<?php echo e(route('front.blog.index')); ?>" class="text-pastel-pink text-[10px] font-semibold tracking-[0.16em] uppercase hover:underline">Blog</a>
        <a href="<?php echo e(route('front.track_order', ['theme' => 'studio'])); ?>" class="text-pastel-pink text-[10px] font-semibold tracking-[0.16em] uppercase hover-underline">Track</a>
      </div>
    </div>
  </div>
      ...
      <div class="flex items-center justify-between h-16 sm:h-20 gap-4">
        ...
        <div class="flex items-center justify-end gap-2 sm:gap-3 lg:gap-4 lg:w-1/3">
          ...
          <div class="relative group/account">
            <a href="<?php echo e(auth()->check() ? route('dashboard') : route('login')); ?>" id="icon-account" class="text-mulberry/70 hover:text-mulberry p-1.5 sm:p-2 transition-all" aria-label="My Account" title="My Account">
            ...
            <div class="absolute right-0 top-full mt-2 w-48 bg-white border border-[#e8ddd0] shadow-xl rounded-sm py-2 opacity-0 invisible group-hover/account:opacity-100 group-hover/account:visible transition-all duration-200 z-50">
              ...
              <a href="<?php echo e(route('dashboard')); ?>" class="block px-4 py-2 text-xs text-gray-700 hover:bg-[#fdfaf6] hover:text-[#b87333]">My Profile</a>
              <a href="<?php echo e(route('front.orders.index')); ?>" class="block px-4 py-2 text-xs text-gray-700 hover:bg-[#fdfaf6] hover:text-[#b87333]">My Orders</a>
              <form action="<?php echo e(route('logout')); ?>" method="POST" class="mt-1 pt-1 border-t border-gray-100">
                <?php echo csrf_field(); ?>
          ...
          <!-- Wishlist -->
          <a href="<?php echo e(route('front.wishlist.index')); ?>" id="icon-wishlist" class="text-mulberry/70 hover:text-mulberry p-1.5 sm:p-2 transition-all" aria-label="Wishlist" title="Wishlist">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <!-- Cart with Badge -->
          <a href="<?php echo e(route('front.cart.index')); ?>" id="icon-cart" class="text-mulberry/70 hover:text-mulberry p-1.5 sm:p-2 transition-all relative" aria-label="Cart" title="Shopping Cart">
            <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
  ...
  <nav class="lg:hidden bg-mulberry border-y border-pastel-pink/40">
    <div class="px-3">
      <ul class="flex items-center gap-2 py-2 overflow-x-auto whitespace-nowrap hide-scrollbar">
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'sale', 'discount' => 1])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">SALE</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'new-arrivals'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'best-sellers'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">BEST SELLERS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'bogo'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">BOGO</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'kids'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">KIDS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'sarees'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">SAREES</a></li>
        <li><a href="<?php echo e(route('front.jewellery')); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">JEWELLERY</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'accessories'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">ACCESSORIES</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'trinkets'])); ?>" class="inline-flex px-3 py-1.5 text-[10px] font-extrabold tracking-[0.16em] uppercase text-pastel-pink border border-pastel-pink/40 rounded-sm">FUN TRINKETS</a></li>
      </ul>
    </div>
  </nav>

  <nav id="main-nav" class="bg-mulberry hidden lg:block" style="border-top: 1px solid rgba(248, 200, 220, 0.35); border-bottom: 2px solid #C75B6E;">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 relative">
      <ul class="flex items-center justify-center gap-4 xl:gap-6 h-12">
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'sale', 'discount' => 1])); ?>" class="nav-item-link rounded-sm">SALE</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'new-arrivals'])); ?>" class="nav-item-link rounded-sm">NEW ARRIVALS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'best-sellers'])); ?>" class="nav-item-link rounded-sm">BEST SELLERS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['collection' => 'bogo'])); ?>" class="nav-item-link rounded-sm">BOGO</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'kids'])); ?>" class="nav-item-link rounded-sm">KIDS</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'sarees'])); ?>" class="nav-item-link rounded-sm">SAREES</a></li>
        <li class="group relative">
          <a href="<?php echo e(route('front.jewellery')); ?>" class="nav-item-link rounded-sm">JEWELLERY</a>
        ...
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'accessories'])); ?>" class="nav-item-link rounded-sm">ACCESSORIES</a></li>
        <li><a href="<?php echo e(route('front.products.index', ['category' => 'trinkets'])); ?>" class="nav-item-link rounded-sm">FUN TRINKETS</a></li>
      </ul>
    </div>
  </nav>
  ...
  <!-- FOOTER                                         -->
  <!-- ═══════════════════════════════════════════════ -->
  <footer class="bg-mulberry text-pastel-pink pt-0 pb-4" style="border-top: 3px solid #C75B6E;">
    ...
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-8 pt-10">
        ...
        <div class="pr-0 lg:pr-6">
          <h4 class="footer-heading text-pastel-pink font-semibold tracking-[0.12em] uppercase text-[17px]"><?php echo e($footerAboutHeading); ?></h4>
          <p class="text-pastel-pink/70 text-[18px] leading-[1.8] mb-4">
            <?php echo e($footerAboutParagraph1); ?>

          </p>
          <p class="text-pastel-pink/70 text-[16px] leading-[1.8] mb-6">
        ...
        <!-- Column 2: Shop -->
        <div>
          <h4 class="footer-heading text-pastel-pink font-semibold tracking-[0.12em] uppercase text-[15px]"><?php echo e($footerShopHeading); ?></h4>
          <ul class="space-y-3.5">
            <li><a href="<?php echo e(route('front.sale.studio.kids')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Kids Collection</a></li>
            <li><a href="<?php echo e(route('front.sale.jewellery')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Jewellery</a></li>
            <li><a href="<?php echo e(route('front.sale.studio.sarees')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Sarees</a></li>
            <li><a href="<?php echo e(route('front.sale.jewellery.accessories')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Hair Accessories</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'organizers'])); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Organizers</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'gifting'])); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Gifting</a></li>
            <li><a href="<?php echo e(route('front.products.collection', ['collection' => 'watches'])); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Watches</a></li>
            <li><a href="<?php echo e(route('front.sale.studio.trinkets')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Trinkets</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-3.5">
            <li><a href="<?php echo e(route('front.page', 'terms-of-service')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Terms of Service</a></li>
            <li><a href="<?php echo e(route('front.page', 'privacy-policy')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Privacy Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'return-exchange-policy')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Returns Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'shipping-policy')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Shipping Policy</a></li>
            <li><a href="<?php echo e(route('front.page', 'faqs')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">FAQ's</a></li>
            <li><a href="<?php echo e(route('front.contact')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Contact Us</a></li>
            <li><a href="<?php echo e(route('front.careers')); ?>" class="text-pastel-pink/75 text-[15px] hover:text-pastel-pink transition-colors">Careers</a></li>
          </ul>
        </div>
  ...
  <div id="mobile-menu-panel"
    ...
    <div class="p-5">
      ...
      <nav class="space-y-1">
        ...
        <a href="<?php echo e(route('front.products.index')); ?>"
...
<?php /**PATH D:\My projects\CP\avnee\avnee_files\resources\views/layouts/front/studio.blade.php ENDPATH**/ ?>