...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        // Customer Stories
        Route::resource('customer-stories', CustomerStoryController::class)
            ->middleware('admin.permission:content.manage')
            ->names('admin.customer-stories');
        Route::post('customer-stories/{customerStory}/toggle-status', [CustomerStoryController::class, 'toggleStatus'])
            ->middleware('admin.permission:content.manage')
            ->name('admin.customer-stories.toggle-status');
