...
Route::get('/campaigns/summer-classics', [HomeController::class, 'summerClassicsCampaign'])->name('front.campaign.summer-classics');
Route::get('/campaigns/birthday-glam', [HomeController::class, 'birthdayGlamCampaign'])->name('front.campaign.birthday-glam');
Route::get('/campaigns/ugadi-sale', [HomeController::class, 'ugadiSaleCampaign'])->name('front.campaign.ugadi-sale');
Route::get('/sale/studio/kids', [ProductController::class, 'studioKidsSale'])->name('front.sale.studio.kids');
Route::get('/sale/studio/sarees', [ProductController::class, 'studioSareesSale'])->name('front.sale.studio.sarees');
Route::get('/sale/jewellery', [ProductController::class, 'jewellerySale'])->name('front.sale.jewellery');
Route::get('/sale/jewellery/accessories', [ProductController::class, 'jewelleryAccessoriesSale'])->name('front.sale.jewellery.accessories');
Route::get('/sale/studio/trinkets', [ProductController::class, 'studioTrinketsSale'])->name('front.sale.studio.trinkets');
...
Route::get('/products/chokers-necklaces', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/rings', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/toe-rings', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/bangles', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/maang-tikka', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/nosepins', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/hair-accessories', [ProductController::class, 'index'])->name('front.products.category');
Route::get('/products/chains', [ProductController::class, 'index'])->name('front.products.category');
...
Route::get('/collections/{collection}', [ProductController::class, 'collection'])
    ->whereIn('collection', [
        'sale', 'new-arrivals', 'best-sellers', 'bogo', 'organizers', 'gifting', 'watches',
        'all-collections', 'party-frocks', 'summer-collections', 'summer-classics', 'birthday-glam', 'ugadi-sale', 'festive-wear', 'daily-wear',
        'all-sarees', 'printed-cotton', 'georgette', 'semi-silk', 'daily-wear-sarees', 'cotton-sarees',
        'hand-made', 'oxidised', 'cultural', 'jewellery-new-arrivals',
    ])
...
Route::get('/women/sarees/all-sarees', [ProductController::class, 'sareesSection'])
    ->defaults('category', 'all-sarees')
    ->name('front.women.sarees.all-sarees');
Route::get('/women/sarees/daily-wear-sarees', [ProductController::class, 'sareesSection'])
    ->defaults('category', 'daily-wear-sarees')
    ->name('front.women.sarees.daily-wear-sarees');
Route::get('/women/sarees/semi-silk-sarees', [ProductController::class, 'sareesSection'])
    ->defaults('category', 'semi-silk-sarees')
    ->name('front.women.sarees.semi-silk-sarees');
Route::get('/women/sarees/cotton-sarees', [ProductController::class, 'sareesSection'])
    ->defaults('category', 'cotton-sarees')
    ->name('front.women.sarees.cotton-sarees');
Route::get('/women/sarees/georgette-sarees', [ProductController::class, 'sareesSection'])
    ->defaults('category', 'georgette-sarees')
    ->name('front.women.sarees.georgette-sarees');
