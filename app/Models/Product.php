...
class Product extends Model
{
    protected $fillable = [
        ...
        'is_returnable', 'show_returnable_badge', 'show_free_shipping_badge',
        'badge_purchase_protection', 'badge_assured_quality', 'badge_returnable_text', 'badge_free_shipping_text',
        'show_purchase_protection_badge', 'show_assured_quality_badge',
    ];
