...
class SettingController extends Controller
{
    private const ALLOWED_SETTING_RULES = [
        ...
        'footer_about_heading' => 'nullable|string|max:120',
        'footer_about_paragraph_1' => 'nullable|string|max:1000',
        'footer_about_paragraph_2' => 'nullable|string|max:1000',
        'footer_shop_heading' => 'nullable|string|max:120',
        'footer_shop_kids_label' => 'nullable|string|max:120',
        'footer_shop_jewellery_label' => 'nullable|string|max:120',
        'footer_shop_sarees_label' => 'nullable|string|max:120',
        'footer_shop_trinkets_label' => 'nullable|string|max:120',
        'footer_shop_hair_label' => 'nullable|string|max:120',
        'footer_shop_all_label' => 'nullable|string|max:120',
    ];
